 ...
 * @public
 */
var DynamicScriptLoadSdkError = /** @class */ (function (_super) {
    __extends(DynamicScriptLoadSdkError, _super);
    function DynamicScriptLoadSdkError(message, cause) {
        return _super.call(this, ErrorCodes.DYNAMIC_SCRIPT_LOAD_ERROR, message, cause) || this;
    }
    return DynamicScriptLoadSdkError;
}(GoodDataSdkError));
