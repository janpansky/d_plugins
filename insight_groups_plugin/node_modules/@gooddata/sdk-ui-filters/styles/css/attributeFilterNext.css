...
.gd-attribute-filter-elements-select-item__next .gd-empty-list-item-tooltip-wrapper {
  margin-left: 5px;
  flex-grow: 1;
}
.gd-attribute-filter-elements-select-item__next .gd-empty-list-item-tooltip-wrapper .gd-empty-list-item-tooltip {
  color: var(--gd-palette-complementary-6, #94a1ad);
}
...
.gd-attribute-filter-list-empty-item .input-checkbox-label .input-label-text .gd-empty-value-tooltip-icon {
  vertical-align: middle;
  color: var(--gd-palette-complementary-6, #94a1ad);
}
...
/*# sourceMappingURL=attributeFilterNext.css.map */
