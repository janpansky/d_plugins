...
export var prepareRankingFilterState = function (filter) {
    ...
    var firstAttribute = attributes === null || attributes === void 0 ? void 0 : attributes[0];
...
var RankingFilterDropdownComponent = function (_a) {
    var measureItems = _a.measureItems, attributeItems = _a.attributeItems, filter = _a.filter, onApply = _a.onApply, onCancel = _a.onCancel, anchorEl = _a.anchorEl, onDropDownItemMouseOver = _a.onDropDownItemMouseOver, onDropDownItemMouseOut = _a.onDropDownItemMouseOut, customGranularitySelection = _a.customGranularitySelection, enableRenamingMeasureToMetric = _a.enableRenamingMeasureToMetric;
