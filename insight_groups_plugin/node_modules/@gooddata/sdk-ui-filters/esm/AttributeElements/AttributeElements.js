...
var AttributeElementsCore = /** @class */ (function (_super) {
    ...
    function AttributeElementsCore() {
        ...
        _this.getValidElements = function () { return __awaiter(_this, void 0, void 0, function () {
            var _a, workspace, options, displayForm, offset, limit, filters, configHash, loader, elements, error_2;
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        loader = this.getBackend()
                            ...
                            .withOffset(offset || 0)
                            .withLimit(limit || 50)
                            .withOptions(options !== null && options !== void 0 ? options : {});
                        if (filters) {
