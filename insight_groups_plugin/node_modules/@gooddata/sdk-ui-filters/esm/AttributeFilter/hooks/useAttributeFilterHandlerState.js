 ...
 * @internal
 */
export var useAttributeFilterHandlerState = function (handler) {
    var workingSelection = handler.getWorkingSelection();
    var committedSelection = handler.getCommittedSelection();
    var initStatus = handler.getInitStatus();
    return {
