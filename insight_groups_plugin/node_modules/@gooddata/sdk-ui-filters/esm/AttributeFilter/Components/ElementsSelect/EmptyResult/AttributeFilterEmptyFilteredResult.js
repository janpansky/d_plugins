...
var ALIGN_POINTS = [{ align: "cr cl" }];
var ARROW_OFFSETS = { "cr cl": [10, 0] };
/**
 * Component that display message that all elements are filtered out by parent filers.
 * @beta
 */
export var AttributeFilterAllValuesFilteredResult = function (props) {
    var parentFilterTitles = props.parentFilterTitles;
