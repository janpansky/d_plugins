 ...
 * @internal
 */
export var RelativeDateFilterForm = function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(GranularityTabs, { availableGranularities: availableGranularities, selectedGranularity: selectedFilterOption.granularity, onSelectedGranularityChange: function (granularity) {
                return onSelectedFilterOptionChange(__assign(__assign(__assign({}, selectedFilterOption), (selectedFilterOption.granularity !== granularity && {
                    from: undefined,
                    to: undefined,
