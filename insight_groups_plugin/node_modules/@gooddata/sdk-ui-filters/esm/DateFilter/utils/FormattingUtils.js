...
export var getLocalizedDateFormat = function (locale) {
    var _a;
    var localizedMoment = moment().locale(translationUtils.sanitizeLocaleForMoment(locale));
    var localeData = (localizedMoment === null || localizedMoment === void 0 ? void 0 : localizedMoment.localeData) && localizedMoment.localeData();
 ...
 */
export var localizedIcuDateFormatPatterns = {
    "en-US": "M/d/y",
    "en-GB": "dd/MM/y",
    "cs-CZ": "d. M. y",
    "de-DE": "d.M.y",
 ...
 * @internal
 */
export var getLocalizedIcuDateFormatPattern = function (locale) { var _a; return (_a = localizedIcuDateFormatPatterns[locale]) !== null && _a !== void 0 ? _a : localizedIcuDateFormatPatterns[DEFAULT_LOCALE]; };
