...
var DateRangePickerInputFieldBody = /** @class */ (function (_super) {
    ...
    DateRangePickerInputFieldBody.prototype.render = function () {
        ...
        return (React.createElement("span", { className: cx(className) },
            ...
            React.createElement("input", __assign({}, this.props, { ref: this.inputRef, className: "input-text s-date-range-picker-input-field" }))));
    };
    return DateRangePickerInputFieldBody;
}(React.Component));
export { DateRangePickerInputFieldBody };
