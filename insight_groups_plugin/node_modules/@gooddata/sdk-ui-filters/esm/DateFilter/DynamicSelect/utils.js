...
export var MINUTE = "GDC.time.minute";
export var HOUR = "GDC.time.hour";
...
var getTrimmedInput = function (input) { return input === null || input === void 0 ? void 0 : input.trim(); };
...
var getOption = function (offset, granularity, intl) {
    ...
    return {
        type: "option",
        value: offset,
        label: intl.formatMessage(messages[dateCode + "_" + offsetCode], { offset: offset, n: Math.abs(offset) }),
    };
};
