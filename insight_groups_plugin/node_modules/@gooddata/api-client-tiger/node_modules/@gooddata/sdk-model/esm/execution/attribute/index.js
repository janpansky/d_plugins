 ...
 * @public
 */
export var anyAttribute = function (_) { return true; };
/**
 * Factory function for attribute predicate which evaluates true for attributes that match particular ID.
 *
 * @public
 */
export var idMatchAttribute = function (id) { return function (attr) {
    return attr.attribute.localIdentifier === id;
}; };
//
//
//
 ...
 * @public
 */
export function attributesFind(attributes, idOrFun) {
