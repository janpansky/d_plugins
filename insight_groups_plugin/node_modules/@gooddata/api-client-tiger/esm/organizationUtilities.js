...
var OrganizationUtilities = /** @class */ (function () {
     ...
     * @internal
     */
    OrganizationUtilities.supportsIncluded = function (entity) {
    ...
    OrganizationUtilities.mergeEntitiesResults = function (pages) {
        return {
            ...
            included: uniqBy(flatMap(pages, function (page) { var _a; return OrganizationUtilities.supportsIncluded(page) ? (_a = page.included) !== null && _a !== void 0 ? _a : [] : []; }), function (item) { return item.id + "_" + item.type; }),
        };
    };
    /**
    ...
    OrganizationUtilities.getAllPagesOf = function (client, entitiesGet, params, options) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var boundGet, results, pageSize, reachedEnd, nextPage, result;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        boundGet = entitiesGet.bind(client.entities);
                        results = [];
                        pageSize = (_a = params === null || params === void 0 ? void 0 : params.size) !== null && _a !== void 0 ? _a : DefaultPageSize;
                        reachedEnd = false;
                        nextPage = 0;
                        _b.label = 1;
                    case 1:
                        if (!!reachedEnd) return [3 /*break*/, 3];
                        return [4 /*yield*/, boundGet(__assign(__assign({}, params), { page: nextPage, size: pageSize }), merge({}, DefaultOptions, options))];
                    case 2:
                        result = _b.sent();
