...
export declare const ActionsApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    scanSql(dataSourceId: string, scanSqlRequest: ScanSqlRequest, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ScanSqlResponse>>;
    /**
     * Test if it is possible to connect to a database using an existing data source definition.
     * @summary Test data source connection by data source id
     * @param {string} dataSourceId Data source id
...
export declare const ActionsApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
     ...
     * @throws {RequiredError}
     */
    scanSql(requestParameters: ActionsApiScanSqlRequest, options?: AxiosRequestConfig | undefined): AxiosPromise<ScanSqlResponse>;
    /**
     * Test if it is possible to connect to a database using an existing data source definition.
     * @summary Test data source connection by data source id
...
export declare class ActionsApi extends BaseAPI implements ActionsApiInterface {
     ...
     * @memberof ActionsApi
     */
    scanSql(requestParameters: ActionsApiScanSqlRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ScanSqlResponse>>;
    /**
     * Test if it is possible to connect to a database using an existing data source definition.
     * @summary Test data source connection by data source id
     * @param {ActionsApiTestDataSourceRequest} requestParameters Request parameters.
