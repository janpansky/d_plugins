...
import { newExecutionDefinitonMethods } from "./internal/definitionMethods";
import { newResultMetaMethods } from "./internal/resultMetaMethods";
import { newResultDataMethods } from "./internal/resultDataMethods";
 ...
 * @public
 */
var DataViewFacade = /** @class */ (function () {
    function DataViewFacade(dataView) {
     ...
     * @public
     */
    DataViewFacade.for = function (dataView) {
     ...
     * @public
     */
    DataViewFacade.forResult = function (result) {
        if (!DataViewFacade.FacadesForResult.has(result)) {
            var emptyView = emptyDataViewForResult(result);
     ...
     * @public
     */
    DataViewFacade.prototype.result = function () {
     ...
     * @public
     */
    DataViewFacade.prototype.warnings = function () {
        var _a;
     ...
     * @public
     */
    DataViewFacade.prototype.fingerprint = function () {
     ...
     * @public
     */
    DataViewFacade.prototype.data = function (config) {
     ...
     * @internal
     */
    DataViewFacade.prototype.def = function () {
     ...
     * @internal
     */
    DataViewFacade.prototype.meta = function () {
     ...
     * @internal
     */
    DataViewFacade.prototype.rawData = function () {
