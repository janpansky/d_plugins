...
var getNumericSymbols = function (intl) {
    return [messages.k, messages.m, messages.g, messages.t, messages.p, messages.e].map(function (desc) {
 ...
 * @internal
 */
export var IntlTranslationsProvider = injectIntl(TranslationsProvider);
