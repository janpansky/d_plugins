...
function updateBucketItemTitle(bucketItem, measureTitleProps) {
    if (isMeasure(bucketItem)) {
        ...
        if (measureTitleProp !== null) {
            var title_1 = measureTitleProp.title, alias_1 = measureTitleProp.alias;
            return modifyMeasure(bucketItem, function (measure) { return measure.title(title_1).alias(alias_1); });
        }
    }
    return bucketItem;
}
function updateVisualizationObjectTitles(insight, measureTitleProps) {
    return insightModifyItems(insight, function (item) { return updateBucketItemTitle(item, measureTitleProps); });
}
/**
