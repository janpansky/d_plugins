...
export declare class ProjectModule {
     ...
     */
    getPermissions(workspaceId: string, userId: string): Promise<GdcUser.IAssociatedProjectPermissions>;
    /**
     ...
     */
    getProjectLcmIdentifiers(domainId: string, projectId?: string, productId?: string, clientId?: string): Promise<GdcProject.IProjectLcmIdentifiers>;
