 ...
 * @experimental
 */
export declare function updateContent(analyticalDashboard: GdcDashboard.IAnalyticalDashboard, uriTranslator: UriTranslator, filterContext: string): GdcDashboard.IAnalyticalDashboardContent;
