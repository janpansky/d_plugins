...
var MetadataModule = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, this.getObjects(projectId, uris)];
                }
            });
        });
    };
    ...
    MetadataModule.prototype.getObjectsByQueryWithPaging = function (projectId, options) {
        var getTotalCount = (options === null || options === void 0 ? void 0 : options.getTotalCount) ? 1 : 0;
