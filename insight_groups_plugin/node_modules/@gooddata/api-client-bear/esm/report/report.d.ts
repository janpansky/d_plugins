...
export declare class ReportModule {
     ...
     */
    exportResult(projectId: string, executionResult: string, exportConfig?: GdcExport.IExportConfig, pollingOptions?: IPollingOptions): Promise<GdcExport.IExportResponse>;
