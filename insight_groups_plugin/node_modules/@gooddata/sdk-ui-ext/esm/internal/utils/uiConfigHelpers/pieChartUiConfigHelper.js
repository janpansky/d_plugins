...
var pieMeasuresIcon = "local:pie/bucket-title-measures.svg";
var pieViewIcon = "local:pie/bucket-title-view.svg";
function setPieChartBucketWarningMessages(referencePoint, intl) {
    ...
    forEach(buckets, function (bucket) {
        ...
        if (!(bucketUiConfig === null || bucketUiConfig === void 0 ? void 0 : bucketUiConfig.canAddItems)) {
            ...
            if (warningMessageId) {
                var warningMessage = getTranslation(warningMessageId, intl);
...
export function setPieChartUiConfig(referencePoint, intl, visualizationType) {
    ...
    var measuresCanAddItems = !hasMoreThanOneCategory(buckets);
