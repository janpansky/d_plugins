...
var tableMeasuresIcon = "local:table/bucket-title-measures.svg";
var tableRowsIcon = "local:table/bucket-title-rows.svg";
var tableColumnsIcon = "local:table/bucket-title-columns.svg";
...
export function getPivotTableDefaultUiConfig(multipleDatesEnabled) {
    return __assign(__assign(__assign({ buckets: __assign({ measures: __assign({}, measuresBase), attribute: __assign(__assign({}, viewBase), { allowsSwapping: true, allowsReordering: true, itemsLimit: MAX_TABLE_CATEGORIES_COUNT, allowsDuplicateDates: multipleDatesEnabled, itemsLimitByType: {
                    date: multipleDatesEnabled ? MAX_TABLE_CATEGORIES_COUNT : 1,
                } }), columns: __assign(__assign({}, viewBase), { allowsSwapping: true, allowsReordering: true, itemsLimit: MAX_TABLE_CATEGORIES_COUNT, allowsDuplicateDates: multipleDatesEnabled, itemsLimitByType: {
                    date: multipleDatesEnabled ? MAX_TABLE_CATEGORIES_COUNT : 1,
