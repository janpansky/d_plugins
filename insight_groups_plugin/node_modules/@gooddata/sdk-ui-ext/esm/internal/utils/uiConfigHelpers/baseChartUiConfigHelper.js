...
var columnMeasuresIcon = "local:column/bucket-title-measures.svg";
var columnViewIcon = "local:column/bucket-title-view.svg";
var columnStackIcon = "local:column/bucket-title-stack.svg";
var barMeasuresIcon = "local:bar/bucket-title-measures.svg";
var barViewIcon = "local:bar/bucket-title-view.svg";
var barStackIcon = "local:bar/bucket-title-stack.svg";
...
function getBucketItemsIcons(bucket, intl) {
    ...
    var orString = intl.formatMessage(messages.or);
