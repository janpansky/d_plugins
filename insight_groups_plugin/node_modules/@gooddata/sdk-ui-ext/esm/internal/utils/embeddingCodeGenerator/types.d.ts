 ...
 */
export declare type PropWithMeta<TProp> = {
    /**
 ...
 */
export declare type PropsWithMeta<TProps> = {
 ...
 */
export declare type InsightToPropsConverter<TProps> = (insight: IInsightDefinition, ctx?: IEmbeddingCodeContext) => PropsWithMeta<TProps>;
/**
