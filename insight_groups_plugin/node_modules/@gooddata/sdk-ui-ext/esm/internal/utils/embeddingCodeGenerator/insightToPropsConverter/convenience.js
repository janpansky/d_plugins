...
export function filtersInsightConversion(propName) {
    return insightConversion(propName, sdkModelPropMetas.Filter.Multiple, function (insight) {
        var _a;
        var filters = (_a = insightFilters(insight)) !== null && _a !== void 0 ? _a : [];
        return filters.filter(function (f) {
            // get rid of the filters AD creates as All time: relative filter without boundaries
            if (isRelativeDateFilter(f)) {
                var _a = relativeDateFilterValues(f), from = _a.from, to = _a.to;
...
export function sortsInsightConversion(propName) {
    return insightConversion(propName, sdkModelPropMetas.SortItem.Multiple, function (insight, ctx) {
        var _a, _b, _c;
        var type = insightVisualizationUrl(insight).split(":")[1];
...
export function localeInsightConversion(propName) {
    return insightConversion(propName, { cardinality: "scalar" }, function (_, ctx) {
        var _a;
        var val = (_a = ctx === null || ctx === void 0 ? void 0 : ctx.settings) === null || _a === void 0 ? void 0 : _a.locale;
