...
export function getMasterMeasuresCount(buckets, bucketLocalIdentifier) {
    var items = getBucketItems(buckets, bucketLocalIdentifier);
...
export function filteredByDerivedMeasure(buckets, filters) {
    ...
    var derivedMeasuresLocalIdentifiers = measures.reduce(function (acc, measure) {
        if (measure.masterLocalIdentifier) {
            acc.push(measure.localIdentifier);
        }
        return acc;
    }, []);
    var allBucketFilters = flatMap(filters.items, function (filterItem) { return filterItem.filters; });
    return allBucketFilters
        .filter(isMeasureValueFilter)
        .some(function (measureValueFilter) {
        return derivedMeasuresLocalIdentifiers.includes(measureValueFilter.measureLocalIdentifier);
    });
}
...
export function hasGlobalDateFilterIgnoreAllTime(filters) {
    if (filters) {
        return some(filters.items, function (item) {
            var _a, _b, _c;
            var interval = (_c = (_b = (_a = item === null || item === void 0 ? void 0 : item.filters) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.interval) !== null && _c !== void 0 ? _c : null;
...
export function hasGlobalDateFilter(filters) {
    if (filters) {
        return some(filters.items, function (item) { var _a, _b; return (_b = (_a = item === null || item === void 0 ? void 0 : item.filters) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.interval; });
    }
    return false;
}
...
function hasNoWeekGranularity(buckets) {
    if (hasDateInCategories(buckets)) {
        return every(getAllAttributeItems(buckets), function (item) { return (item === null || item === void 0 ? void 0 : item.granularity) !== GRANULARITY.week; });
    }
    return every(getBucketItems(buckets, FILTERS), function (item) { return (item === null || item === void 0 ? void 0 : item.granularity) !== GRANULARITY.week; });
}
function hasNoMeasureDateFilter(buckets) {
    return !some(getMeasureItems(buckets), function (item) {
        var filters = item === null || item === void 0 ? void 0 : item.filters;
...
function hasFirstDate(buckets) {
    var _a;
    var firstAttributeItem = (_a = getAllAttributeItems(buckets)) === null || _a === void 0 ? void 0 : _a[0];
...
export function hasNonAllTimeFilter(filters) {
    var _a, _b, _c, _d, _e;
    var filterBucketItems = (_a = filters === null || filters === void 0 ? void 0 : filters.items) !== null && _a !== void 0 ? _a : [];
    ...
    var filterInterval = (_e = (_d = (_c = (_b = dateFilter === null || dateFilter === void 0 ? void 0 : dateFilter.filters) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.interval) === null || _d === void 0 ? void 0 : _d.interval) !== null && _e !== void 0 ? _e : [];
...
export function isShowInPercentAllowed(buckets, filters, bucketLocalIdentifier) {
    var rules = [hasNoStacks, hasSomeCategories, hasNoRankingFilter];
...
export function isComparisonOverTimeAllowed(buckets, filters, weekFiltersEnabled) {
    var rules = weekFiltersEnabled ? [hasNoStacksWithDate] : [hasNoStacksWithDate, hasNoWeekGranularity];
...
export function overTimeComparisonRecommendationEnabled(referencePoint, weekFiltersEnabled) {
    ...
    var rules = weekFiltersEnabled ? baseRules : __spreadArrays(baseRules, [hasNoWeekGranularity]);
