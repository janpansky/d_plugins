...
var BigChartDescriptor = /** @class */ (function (_super) {
    __extends(BigChartDescriptor, _super);
    function BigChartDescriptor() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    BigChartDescriptor.prototype.getSizeInfo = function (_insight, layoutDescriptor, settings) {
        return {
            width: {
                default: 6,
                min: 4,
    ...
    BigChartDescriptor.prototype.getMinHeight = function (enableCustomHeight) {
        if (!enableCustomHeight) {
            return DASHBOARD_LAYOUT_DEFAULT_VIS_HEIGHT;
        }
        return MIDDLE_VISUALIZATION_HEIGHT;
    };
    return BigChartDescriptor;
}(BaseChartDescriptor));
export { BigChartDescriptor };
