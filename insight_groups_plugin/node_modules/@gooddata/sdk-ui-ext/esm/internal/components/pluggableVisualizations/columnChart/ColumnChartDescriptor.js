...
var ColumnChartDescriptor = /** @class */ (function (_super) {
    ...
    ColumnChartDescriptor.prototype.applyDrillDown = function (insight, drillDownContext, backendSupportsElementUris) {
        var withFilters = this.addFiltersForColumnBar(insight, drillDownContext.drillDefinition, drillDownContext.event, backendSupportsElementUris);
        return modifyBucketsAttributesForDrillDown(withFilters, drillDownContext.drillDefinition);
    };
    ColumnChartDescriptor.prototype.getMeta = function () {
        return {
    ...
    ColumnChartDescriptor.prototype.addFiltersForColumnBar = function (insight, drillConfig, event, backendSupportsElementUris) {
