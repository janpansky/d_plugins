...
export function convertIntersectionToFilters(intersections, backendSupportsElementUris) {
    if (backendSupportsElementUris === void 0) { backendSupportsElementUris = true; }
...
export function addIntersectionFiltersToInsight(source, intersection, backendSupportsElementUris) {
    var filters = convertIntersectionToFilters(intersection, backendSupportsElementUris);
