...
var LabelSubsection = /** @class */ (function (_super) {
    ...
    LabelSubsection.prototype.render = function () {
        ...
        return (React.createElement(ConfigSubsection, { title: messages.axisLabels.id, valuePath: this.props.axis + ".labelsEnabled", properties: this.props.properties, pushData: this.props.pushData, canBeToggled: true, toggledOn: axisLabelsEnabled, toggleDisabled: this.props.disabled || !axisVisible, showDisabledMessage: !this.props.configPanelDisabled && this.props.disabled },
