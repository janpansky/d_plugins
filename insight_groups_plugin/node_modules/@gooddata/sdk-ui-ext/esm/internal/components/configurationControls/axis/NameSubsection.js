...
var NameSubsection = /** @class */ (function (_super) {
    ...
    NameSubsection.prototype.render = function () {
        ...
        return (React.createElement(ConfigSubsection, { title: messages.axisName.id, valuePath: axis + ".name.visible", properties: properties, pushData: pushData, canBeToggled: true, toggledOn: axisNameVisible, toggleDisabled: disabled || !axisVisible, showDisabledMessage: !configPanelDisabled && disabled },
