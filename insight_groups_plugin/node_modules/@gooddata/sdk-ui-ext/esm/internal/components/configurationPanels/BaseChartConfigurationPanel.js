...
var BaseChartConfigurationPanel = /** @class */ (function (_super) {
    ...
    BaseChartConfigurationPanel.prototype.renderCanvasSection = function () {
        ...
        var _b = this.props, properties = _b.properties, propertiesMeta = _b.propertiesMeta, pushData = _b.pushData, featureFlags = _b.featureFlags;
        ...
        return (React.createElement(ConfigSection, { id: "canvas_section", title: messages.canvasTitle.id, propertiesMeta: propertiesMeta, properties: properties, pushData: pushData },
            React.createElement(DataLabelsControl, { pushData: pushData, properties: properties, isDisabled: controlsDisabled, isTotalsDisabled: controlsDisabled || !!((_a = properties === null || properties === void 0 ? void 0 : properties.controls) === null || _a === void 0 ? void 0 : _a.stackMeasuresToPercent), enableSeparateTotalLabels: !!featureFlags.enableSeparateTotalLabels }),
