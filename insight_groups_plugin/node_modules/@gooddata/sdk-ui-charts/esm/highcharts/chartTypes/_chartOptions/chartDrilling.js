...
export function getDrillableSeries(dv, series, drillableItems, viewByAttributes, stackByAttribute, type) {
    ...
    return series.map(function (seriesItem) {
        ...
        var data = (_a = seriesItem.data) === null || _a === void 0 ? void 0 : _a.map(function (pointData, pointIndex) {
            var _a, _b;
            var measureHeaders = [];
            ...
            var _e = getViewBy(viewByParentAttribute, viewByIndex), viewByParentHeader = _e.viewByHeader, viewByParentAttributeDescriptor = _e.viewByAttributeDescriptor;
