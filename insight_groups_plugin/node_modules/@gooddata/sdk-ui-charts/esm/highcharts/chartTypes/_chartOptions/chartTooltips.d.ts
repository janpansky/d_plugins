...
export declare function generateTooltipHeatmapFn(viewByAttribute: IUnwrappedAttributeHeadersWithItems, stackByAttribute: IUnwrappedAttributeHeadersWithItems, config?: IChartConfig): ITooltipFactory;
export declare function buildTooltipTreemapFactory(viewByAttribute: IUnwrappedAttributeHeadersWithItems, stackByAttribute: IUnwrappedAttributeHeadersWithItems, config?: IChartConfig): ITooltipFactory;
export declare function getTooltipFactory(isViewByTwoAttributes: boolean, viewByAttribute: IUnwrappedAttributeHeadersWithItems, viewByParentAttribute: IUnwrappedAttributeHeadersWithItems, stackByAttribute: IUnwrappedAttributeHeadersWithItems, measure: IMeasureDescriptor, config?: IChartConfig, isDualAxis?: boolean): ITooltipFactory;
