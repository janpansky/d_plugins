...
export var getVisibleSeries = function (chart) { var _a; return (_a = chart.series) === null || _a === void 0 ? void 0 : _a.filter(function (s) { return s.visible; }); };
export var getHiddenSeries = function (chart) { var _a; return (_a = chart.series) === null || _a === void 0 ? void 0 : _a.filter(function (s) { return !s.visible; }); };
...
export var isStacked = function (chart) {
    ...
    var isStackedByChartType = !!((_c = (_b = (_a = chart.userOptions) === null || _a === void 0 ? void 0 : _a.plotOptions) === null || _b === void 0 ? void 0 : _b[chartType]) === null || _c === void 0 ? void 0 : _c.stacking);
    var isStackedBySeries = !!((_f = (_e = (_d = chart.userOptions) === null || _d === void 0 ? void 0 : _d.plotOptions) === null || _e === void 0 ? void 0 : _e.series) === null || _f === void 0 ? void 0 : _f.stacking);
    var hasStackedAxis = chart.axes.some(function (axis) { var _a; return !isEmpty((_a = axis === null || axis === void 0 ? void 0 : axis.stacking) === null || _a === void 0 ? void 0 : _a.stacks); });
...
function getSerieMaxDataValue(serieData) {
    var max = maxBy(serieData, function (item) { return ((item === null || item === void 0 ? void 0 : item.y) ? item.y : null); });
    return max ? max.y : Number.MIN_SAFE_INTEGER;
}
function getSerieMinDataValue(serieData) {
    var min = minBy(serieData, function (item) { return ((item === null || item === void 0 ? void 0 : item.y) ? item.y : null); });
