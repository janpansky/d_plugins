...
import { formatAsPercent, getLabelStyle, getLabelsVisibilityConfig, getTotalsVisibility, } from "./dataLabelsHelpers";
...
function getLabelsConfiguration(chartOptions, _config, chartConfig) {
    ...
    var totalsVisible = getTotalsVisibility(type, chartConfig);
...
function getTotalLabelsConfig(chartType, chartConfig) {
    var _a, _b;
    ...
    return getLabelsVisibilityConfig(!isNil(totalsVisible) ? totalsVisible : (_b = chartConfig === null || chartConfig === void 0 ? void 0 : chartConfig.dataLabels) === null || _b === void 0 ? void 0 : _b.visible);
}
function getStackingConfiguration(chartOptions, _config, chartConfig) {
    ...
    var totalLabelsConfig = getTotalLabelsConfig(type, chartConfig);
