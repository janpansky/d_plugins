...
import { DataViewFacade, VisualizationTypes } from "@gooddata/sdk-ui";
import { IChartConfig } from "../../../interfaces";
import { StackingType } from "../../constants/stacking";
import { ISeriesItem } from "../../typings/unsafe";
export declare const CHART_ORDER: {
    area: number;
    column: number;
    line: number;
};
 ...
 * @internal
 */
export declare const COMBO_SUPPORTED_CHARTS: ("column" | "area" | "line")[];
