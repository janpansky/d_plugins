...
export var ClientWorkspaceProvider = function (props) {
    ...
    return (React.createElement(ClientWorkspaceContext.Provider, { value: __assign(__assign({}, lcmIdentifiers), { isInitialized: true }) },
 ...
 * @alpha
 */
export var useClientWorkspaceInitialized = function () {
    var context = React.useContext(ClientWorkspaceContext);
