...
})(ColumnEventSourceType || (ColumnEventSourceType = {}));
/**
 * @internal
 */
export var UIClick;
...
export function newWidthForAttributeColumn(attributeOrId, width, allowGrowToFit) {
    var growToFitProp = allowGrowToFit !== undefined ? { allowGrowToFit: allowGrowToFit } : {};
    return {
        attributeColumnWidthItem: {
            attributeIdentifier: attributeLocalId(attributeOrId),
            width: __assign({ value: width }, growToFitProp),
        },
    };
}
/**
...
export function newWidthForAllColumnsForMeasure(measureOrId, width, allowGrowToFit) {
    var locator = newMeasureColumnLocator(measureOrId);
    var growToFitProp = allowGrowToFit !== undefined ? { allowGrowToFit: allowGrowToFit } : {};
    return {
        measureColumnWidthItem: {
            width: __assign({ value: width }, growToFitProp),
...
export function newWidthForSelectedColumns(measureOrId, locators, width, allowGrowToFit) {
    var measureLocator = newMeasureColumnLocator(measureOrId);
    var growToFitProp = allowGrowToFit !== undefined && width !== "auto" ? { allowGrowToFit: allowGrowToFit } : {};
    // Note: beware here. The attribute locators _must_ come first for some obscure, impl dependent reason
    return {
        measureColumnWidthItem: {
            width: __assign({ value: width }, growToFitProp),
            locators: __spreadArrays(locators, [measureLocator]),
        },
    };
}
/**
