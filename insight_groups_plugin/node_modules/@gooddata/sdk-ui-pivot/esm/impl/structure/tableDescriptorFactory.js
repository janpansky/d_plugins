 ...
 * @internal
 */
export function createHeadersAndColDefs(dv, emptyHeaderTitle) {
    var headers = createTableHeaders(dv);
    var colDefs = createColDefsFromTableDescriptor(headers, dv.meta().effectiveSortItems(), emptyHeaderTitle);
