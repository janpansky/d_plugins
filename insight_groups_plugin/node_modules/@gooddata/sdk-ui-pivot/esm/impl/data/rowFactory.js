...
import { emptyHeaderTitleFromIntl, getMappingHeaderFormattedName, } from "@gooddata/sdk-ui";
...
function getCell(rowHeaderData, rowIndex, rowHeader, rowHeaderIndex, intl) {
    ...
    if (isResultAttributeHeader(rowHeaderDataItem)) {
        return __assign(__assign({}, cell), { value: valueWithEmptyHandling(getMappingHeaderFormattedName(rowHeaderDataItem), emptyHeaderTitleFromIntl(intl)) });
    }
