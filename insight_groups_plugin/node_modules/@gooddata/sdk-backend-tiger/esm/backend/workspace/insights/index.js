...
import { objRefToString, insightTitle, insightId, mergeFilters, insightFilters, insightSetFilters, insightUpdated, insightTags, insightSummary, } from "@gooddata/sdk-model";
...
var TigerWorkspaceInsights = /** @class */ (function () {
    function TigerWorkspaceInsights(authCall, workspace) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, insightFromInsightDefinition(insight, insightData.data.id, insightData.links.self, (_a = insightData.data.attributes) === null || _a === void 0 ? void 0 : _a.tags, isInheritedObject(insightData.data))];
                }
            });
        }); };
        ...
        this.getInsightReferencingObjects = function (ref) { return __awaiter(_this, void 0, void 0, function () {
            var id, entitiesGraph, analyticalDashboards;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, objRefToIdentifier(ref, this.authCall)];
                    ...
                    case 2:
                        ...
                        analyticalDashboards = entitiesGraph.nodes
                            .filter(function (_a) {
                            var type = _a.type;
                            return type === "analyticalDashboard";
                        })
                            .map(convertGraphEntityNodeToAnalyticalDashboard);
                        return [2 /*return*/, { analyticalDashboards: analyticalDashboards }];
                }
            });
        }); };
