import { IInsightsQueryOptions, IInsightsQueryResult, IInsightReferences, IInsightReferencing, IWorkspaceInsightsService, IGetInsightOptions } from "@gooddata/sdk-backend-spi";
...
export declare class TigerWorkspaceInsights implements IWorkspaceInsightsService {
    ...
    getInsightReferencedObjects: (_insight: IInsight, _types?: ("measure" | "fact" | "attribute" | "dataSet" | "analyticalDashboard" | "theme" | "visualizationObject" | "filterContext" | "dashboardPlugin")[] | undefined) => Promise<IInsightReferences>;
