...
import { insightMeasures, insightAttributes, isAttribute, isFilter, isMeasure, insightFilters, areObjRefsEqual, isCatalogAttribute, isCatalogFact, isCatalogMeasure, } from "@gooddata/sdk-model";
...
var TigerWorkspaceCatalogAvailableItemsFactory = /** @class */ (function () {
    ...
    TigerWorkspaceCatalogAvailableItemsFactory.prototype.withGroups = function (loadGroups) {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        _c = convertAfmFilters(measures, filters), afmFilters = _c.filters, auxMeasures = _c.auxMeasures;
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new TigerWorkspaceCatalogWithAvailableItems(this.groups, this.items, availableItems, this.options)];
                }
            });
        });
    };
