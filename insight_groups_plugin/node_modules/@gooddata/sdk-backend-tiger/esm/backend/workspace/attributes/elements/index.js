...
var TigerWorkspaceElements = /** @class */ (function () {
    function TigerWorkspaceElements(authCall, workspace, dateFormatter) {
...
var TigerWorkspaceElementsQuery = /** @class */ (function () {
    function TigerWorkspaceElementsQuery(authCall, ref, workspace, dateFormatter) {
        this.authCall = authCall;
        this.ref = ref;
        this.workspace = workspace;
        this.dateFormatter = dateFormatter;
    ...
    TigerWorkspaceElementsQuery.prototype.withSignal = function (signal) {
        this.signal = signal;
        return this;
    };
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, ServerPaging.for(function (_a) {
                        ...
                        return __awaiter(_this, void 0, void 0, function () {
                            var response, _b, paging, elements, format, granularity, elementsGranularity, sdkGranularity, locale, pattern, shouldFormatTitle, dateValueFormatter;
                            var _this = this;
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0: return [4 /*yield*/, this.authCall(function (client) {
                                            ...
                                            return client.labelElements.computeLabelElementsPost(elementsRequestWrapped, __assign({}, new TigerCancellationConverter(_this.signal).forAxios()));
                                        })];
                                    case 1:
                                        response = _c.sent();
                                        _b = response.data, paging = _b.paging, elements = _b.elements, format = _b.format, granularity = _b.granularity;
                                        elementsGranularity = granularity;
                                        sdkGranularity = toSdkGranularity(elementsGranularity);
                                        locale = format === null || format === void 0 ? void 0 : format.locale;
                                        pattern = format === null || format === void 0 ? void 0 : format.pattern;
                                        shouldFormatTitle = sdkGranularity && format;
                                        dateValueFormatter = createDateValueFormatter(this.dateFormatter);
                                        return [2 /*return*/, {
                                                items: elements.map(function (element) {
                                                    var _a;
                                                    var objWithFormattedTitle = shouldFormatTitle
                                                        ? {
                                                            formattedTitle: dateValueFormatter(element.title, sdkGranularity, locale, pattern),
                                                        }
                                                        : {};
                                                    return __assign({ title: element.title, uri: (_a = element.primaryTitle) !== null && _a !== void 0 ? _a : element.title }, objWithFormattedTitle);
                                                }),
