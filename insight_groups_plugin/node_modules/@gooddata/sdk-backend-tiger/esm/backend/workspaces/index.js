...
var TigerWorkspaceQuery = /** @class */ (function () {
            ...
            return function (results) {
                if (search) {
                    ...
                    return results.filter(function (workspace) {
                        ...
                        return (title === null || title === void 0 ? void 0 : title.toLowerCase().indexOf(lowercaseSearch_1)) > -1;
                    });
                }
                return results;
            };
    ...
    TigerWorkspaceQuery.prototype.withParent = function (workspaceId) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.authCall(function (client) {
                            var filterParam = _this.parentWorkspaceId ? "parent.id==" + _this.parentWorkspaceId : undefined;
