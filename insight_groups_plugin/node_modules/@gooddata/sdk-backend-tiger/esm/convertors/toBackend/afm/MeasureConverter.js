...
import { toDateDataSetQualifier, toFactQualifier, toLocalIdentifier, toAttributeQualifier, } from "../ObjRefConverter";
...
function convertInlineMeasureDefinition(definition) {
    var inlineDefinition = definition.inlineDefinition;
    return {
        inline: {
