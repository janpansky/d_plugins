...
export declare type FormattingLocale = keyof typeof localeConversions;
/**
 ...
 * @alpha
 */
export declare const defaultDateFormatter: (value: Date, granularity: DateAttributeGranularity, locale?: FormattingLocale, pattern?: string | undefined) => string;
export {};
