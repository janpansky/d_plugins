 ...
 */
var TigerToSdkGranularityMap = (_a = {},
    _a[JsonApiAttributeOutAttributesGranularityEnum.YEAR] = "GDC.time.year",
    _a[JsonApiAttributeOutAttributesGranularityEnum.QUARTER] = "GDC.time.quarter",
    _a[JsonApiAttributeOutAttributesGranularityEnum.MONTH] = "GDC.time.month",
    _a[JsonApiAttributeOutAttributesGranularityEnum.WEEK] = "GDC.time.week_us",
    _a[JsonApiAttributeOutAttributesGranularityEnum.DAY] = "GDC.time.date",
    _a[JsonApiAttributeOutAttributesGranularityEnum.HOUR] = "GDC.time.hour",
    _a[JsonApiAttributeOutAttributesGranularityEnum.MINUTE] = "GDC.time.minute",
    _a[JsonApiAttributeOutAttributesGranularityEnum.QUARTER_OF_YEAR] = "GDC.time.quarter_in_year",
    _a[JsonApiAttributeOutAttributesGranularityEnum.MONTH_OF_YEAR] = "GDC.time.month_in_year",
    _a[JsonApiAttributeOutAttributesGranularityEnum.WEEK_OF_YEAR] = "GDC.time.week_in_year",
    _a[JsonApiAttributeOutAttributesGranularityEnum.DAY_OF_YEAR] = "GDC.time.day_in_year",
    _a[JsonApiAttributeOutAttributesGranularityEnum.DAY_OF_MONTH] = "GDC.time.day_in_month",
    _a[JsonApiAttributeOutAttributesGranularityEnum.DAY_OF_WEEK] = "GDC.time.day_in_week",
    _a[JsonApiAttributeOutAttributesGranularityEnum.HOUR_OF_DAY] = "GDC.time.hour_in_day",
    _a[JsonApiAttributeOutAttributesGranularityEnum.MINUTE_OF_HOUR] = "GDC.time.minute_in_hour",
    _a);
/**
...
export function toTigerGranularity(granularity) {
    var tigerGranularity = SdkToTigerGranularityMap[granularity];
    if (!tigerGranularity) {
