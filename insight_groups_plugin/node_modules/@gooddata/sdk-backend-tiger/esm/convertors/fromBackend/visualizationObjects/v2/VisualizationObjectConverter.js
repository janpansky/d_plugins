...
export function convertVisualizationObject(visualizationObject, title, description, tags) {
    var _a, _b, _c;
    var _ = visualizationObject.version, data = __rest(visualizationObject, ["version"]);
    var convertedInsight = {
        insight: __assign(__assign({}, data), { title: title, summary: description, buckets: (_a = cloneWithSanitizedIds(visualizationObject.buckets)) !== null && _a !== void 0 ? _a : [], filters: (_b = cloneWithSanitizedIds(visualizationObject.filters)) !== null && _b !== void 0 ? _b : [], sorts: (_c = cloneWithSanitizedIds(visualizationObject.sorts)) !== null && _c !== void 0 ? _c : [], tags: tags }),
    };
