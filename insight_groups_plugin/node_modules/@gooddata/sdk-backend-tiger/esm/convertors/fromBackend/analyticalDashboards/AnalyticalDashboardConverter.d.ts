import { JsonApiAnalyticalDashboardOutDocument, JsonApiAnalyticalDashboardOutList, JsonApiAnalyticalDashboardOutWithLinks, JsonApiFilterContextOutDocument, JsonApiDashboardPluginOutDocument, JsonApiDashboardPluginOutWithLinks } from "@gooddata/api-client-tiger";
import { IFilterContext, IDashboard, IListedDashboard, IDashboardPlugin } from "@gooddata/sdk-model";
export declare const convertAnalyticalDashboard: (analyticalDashboard: JsonApiAnalyticalDashboardOutWithLinks) => IListedDashboard;
...
export declare function convertDashboardPluginWithLinksFromBackend(plugin: JsonApiDashboardPluginOutWithLinks): IDashboardPlugin;
