import { Timestamp, MaqlExpression, Uri, NumberAsString, BooleanAsString, ThemeColor, ThemeFontUri } from "../aliases";
import { GdcExecuteAFM } from "../executeAfm/GdcExecuteAFM";
/**
 * @public
 */
export declare namespace GdcMetadata {
    ...
    interface IAttribute extends IMetadataObject {
        content: {
            dimension?: string;
    ...
    function isAttribute(obj: unknown): obj is IAttribute;
