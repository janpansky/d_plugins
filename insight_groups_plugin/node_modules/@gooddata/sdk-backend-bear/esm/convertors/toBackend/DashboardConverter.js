...
export var convertWidget = function (widget) {
    ...
    if (widget.type === "kpi") {
        ...
        var kpi = widget.kpi, configuration_1 = widget.configuration;
        return {
            kpi: {
                content: __assign(__assign(__assign({}, (isKpiWithComparison(kpi)
                    ? {
                    ...
                    : {
                        comparisonType: kpi.comparisonType,
                    })), { metric: refToUri(kpi.metric), ignoreDashboardFilters: convertedIgnoredDashboardFilters, dateDataSet: convertedDateDataSet, drillTo: drills.length > 0 ? convertDrill(drills[0]) : undefined }), (configuration_1 ? { configuration: configuration_1 } : {})),
                meta: meta,
            },
        };
    }
