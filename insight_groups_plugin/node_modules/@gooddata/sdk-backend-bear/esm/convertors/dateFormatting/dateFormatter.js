...
export function transformDateFormat(resultHeader, dateAttributeUris, dateFormat) {
    ...
    var foundUri = dateAttributeUris.some(function (dateAttributeUri) { return resultHeaderUri === null || resultHeaderUri === void 0 ? void 0 : resultHeaderUri.startsWith(dateAttributeUri); });
    if (!foundUri) {
        return resultHeader;
    }
    try {
