...
export declare function convertWarning(warning: GdcExecution.Warning): IResultWarning;
/**
 ...
 */
export declare function convertDimensions(dims: GdcExecution.IResultDimension[]): IDimensionDescriptor[];
