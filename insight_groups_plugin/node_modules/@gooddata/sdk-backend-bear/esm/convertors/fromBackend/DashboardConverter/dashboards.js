...
export var convertListedDashboard = function (dashboardLink, availability, userMap) {
    var _a, _b, _c;
    var isUnderStrictControlProp = ((_a = dashboardLink.flags) === null || _a === void 0 ? void 0 : _a.some(function (flag) { return flag === "strictAccessControl"; })) ? {
    ...
    return __assign({ ref: uriRef(dashboardLink.link), identifier: dashboardLink.identifier, uri: dashboardLink.link, title: dashboardLink.title, description: dashboardLink.summary, updated: dashboardLink.updated, updatedBy: dashboardLink.contributor ? userMap === null || userMap === void 0 ? void 0 : userMap.get(dashboardLink.contributor) : undefined, created: dashboardLink.created, createdBy: dashboardLink.author ? userMap === null || userMap === void 0 ? void 0 : userMap.get(dashboardLink.author) : undefined, 
        ...
        tags: (_c = (_b = dashboardLink.tags) === null || _b === void 0 ? void 0 : _b.split(" ").filter(Boolean)) !== null && _c !== void 0 ? _c : [], isLocked: !!dashboardLink.locked, shareStatus: getShareStatus(!!dashboardLink.unlisted, !!dashboardLink.sharedWithSomeone), availability: availability }, isUnderStrictControlProp);
};
...
export var convertDashboard = function (dashboard, dependencies, visualizationClasses, exportFilterContextUri, userMap) {
    ...
    var isUnderStrictControlProp = (flags === null || flags === void 0 ? void 0 : flags.some(function (flag) { return flag === "strictAccessControl"; })) ? {
        isUnderStrictControl: true,
    }
        : {};
