...
var BearWorkspaceInsights = /** @class */ (function () {
    function BearWorkspaceInsights(authCall, workspace) {
        ...
        this.getInsightsInner = function (options, visualizationClassUrlByVisualizationClassUri, userMap) { return __awaiter(_this, void 0, void 0, function () {
            var mergedOptions, defaultLimit;
            var _this = this;
            var _a;
            return __generator(this, function (_b) {
                ...
                return [2 /*return*/, ServerPaging.for(function (_a) {
                        ...
                        return __awaiter(_this, void 0, void 0, function () {
                            var data, items, totalCount, updatedUserMap, _b, insights;
                            var _this = this;
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, updateUserMap(userMap, flatMap(items, getVisualizationUserUris), this.authCall)];
                                    case 2:
                                        _b = _c.sent();
                                        return [3 /*break*/, 4];
                                    case 3:
                                    ...
                                    case 4:
                                        updatedUserMap = _b;
                                        insights = items.map(function (visualization) {
