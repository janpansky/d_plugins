...
export declare class BearExecutionResult implements IExecutionResult {
    ...
    constructor(authApiCall: BearAuthenticatedCallGuard, definition: IExecutionDefinition, execFactory: IExecutionFactory, execResponse: GdcExecution.IExecutionResponse);
