...
var BearWorkspaceDashboards = /** @class */ (function () {
    function BearWorkspaceDashboards(authCall, workspace) {
        ...
        this.getDashboard = function (dashboardRef, exportFilterContextRef, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var dashboardUri, exportFilterContextUri, _a, bearDashboard, dependenciesToGet, bearVisualizationClasses, _b, _c, _d, _f, bearDependencies, bearExportFilterContext, userMap, _g;
                return __generator(this, function (_h) {
                    switch (_h.label) {
                        case 0: return [4 /*yield*/, objRefToUri(dashboardRef, this.workspace, this.authCall)];
                        case 1:
                            dashboardUri = _h.sent();
                        ...
                        case 8:
                            _f = _h.sent(), bearDependencies = _f[0], bearExportFilterContext = _f[1];
        ...
        this.getDashboardPermissions = function (ref) { return __awaiter(_this, void 0, void 0, function () {
            var uri_1, workspacePermissions, canEditDashboard, canShareDashboard, canManageLockedDashboard, _e_1;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        return [4 /*yield*/, objRefToUri(ref, this.workspace, this.authCall)];
                    case 1:
                        uri_1 = _a.sent();
                        return [4 /*yield*/, this.authCall(function (sdk) {
                                return sdk.md.getObjectDetails(uri_1);
                            })];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.authCall(function () {
                                return _this.permissions.getPermissionsForCurrentUser();
                            })];
                    case 3:
                        workspacePermissions = _a.sent();
                        canEditDashboard = workspacePermissions.canManageAnalyticalDashboard;
                        canShareDashboard = workspacePermissions.canManageACL;
                        canManageLockedDashboard = canEditDashboard && workspacePermissions.canManageProject;
                        return [2 /*return*/, {
                                canEditDashboard: canEditDashboard,
                                canEditLockedDashboard: canManageLockedDashboard,
                                canShareDashboard: canShareDashboard,
        ...
        this.validateDashboardsExistence = function (dashboardRefs) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.all(dashboardRefs.map(function (ref) { return __awaiter(_this, void 0, void 0, function () {
                            var _a, title, identifier, isUnderStrictControl, uri, error_1;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        _b.trys.push([0, 2, , 3]);
                                        return [4 /*yield*/, this.getDashboard(ref)];
                                    case 1:
                                        _a = _b.sent(), title = _a.title, identifier = _a.identifier, isUnderStrictControl = _a.isUnderStrictControl, uri = _a.uri;
                    ...
                    case 1:
                        validDashboards = _a.sent();
                        return [2 /*return*/, compact(validDashboards)];
                }
            });
        }); };
