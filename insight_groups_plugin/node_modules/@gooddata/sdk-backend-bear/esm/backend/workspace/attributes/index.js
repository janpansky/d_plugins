...
var BearWorkspaceAttributes = /** @class */ (function () {
    function BearWorkspaceAttributes(authCall, workspace) {
        ...
        this.getAttribute = function (ref) { return __awaiter(_this, void 0, void 0, function () {
            var attributeUri, wrappedAttribute;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, objRefToUri(ref, this.workspace, this.authCall)];
                    case 1:
                        attributeUri = _a.sent();
                        return [4 /*yield*/, this.authCall(function (sdk) {
                                return sdk.md.getObjectDetails(attributeUri);
                            })];
                    case 2:
                        wrappedAttribute = _a.sent();
                        return [2 /*return*/, this.buildAttribute(wrappedAttribute.attribute)];
                }
            });
        }); };
        ...
        this.buildAttribute = function (attributeDetails) {
            var _a = attributeDetails.meta, title = _a.title, uri = _a.uri, isProduction = _a.isProduction, identifier = _a.identifier, summary = _a.summary;
            var displayForms = attributeDetails.content.displayForms;
            var attributeDisplayForms = displayForms.map(function (displayForm) {
                return _this.buildAttributeDisplayForm(displayForm);
            });
            var ref = uriRef(uri);
    ...
    BearWorkspaceAttributes.prototype.getCommonAttributesBatch = function (attributesRefsBatch) {
        var _this = this;
        return Promise.all(attributesRefsBatch.map(function (attributeRefs) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.getCommonAttributes(attributeRefs)];
            });
        }); }));
    };
    BearWorkspaceAttributes.prototype.getAttributeByDisplayForm = function (ref) {
        return __awaiter(this, void 0, void 0, function () {
            var displayFormUri, wrappedDisplayForm, wrappedAttribute;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, objRefToUri(ref, this.workspace, this.authCall)];
                    case 1:
                    ...
                    case 2:
                        wrappedDisplayForm = _a.sent();
                        return [4 /*yield*/, this.authCall(function (sdk) {
                                return sdk.md.getObjectDetails(wrappedDisplayForm.attributeDisplayForm.content.formOf);
                            })];
                    case 3:
                        wrappedAttribute = _a.sent();
                        return [2 /*return*/, this.buildAttribute(wrappedAttribute.attribute)];
