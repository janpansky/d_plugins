...
import { isCatalogAttribute, isCatalogFact, isCatalogMeasure, insightItems, isAttribute, isArithmeticMeasure, isSimpleMeasure, attributeDisplayFormRef, isIdentifierRef, modifyAttribute, uriRef, modifySimpleMeasure, measureItem, attributeLocalId, measureLocalId, measureMasterIdentifier, isPoPMeasure, isPreviousPeriodMeasure, isMeasure, measurePopAttribute, modifyPopMeasure, } from "@gooddata/sdk-model";
...
var BearWorkspaceCatalogAvailableItemsFactory = /** @class */ (function () {
    ...
    BearWorkspaceCatalogAvailableItemsFactory.prototype.withGroups = function (loadGroups) {
        return this.withOptions({ loadGroups: loadGroups });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new BearWorkspaceCatalogWithAvailableItems(this.groups, this.items, allAvailableCatalogItems, this.options)];
                }
            });
        });
    };
