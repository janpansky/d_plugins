...
var GeoChartOptionsWrapper = /** @class */ (function (_super) {
    ...
    function GeoChartOptionsWrapper(props) {
        ...
        _this.buildGeoChartOptions = function (geoData, props) {
            ...
            var categoryItems = segment ? _this.getCategoryLegendItems(colorStrategy) : [];
            return {
                geoData: geoData,
        ...
        _this.nullHeaderString = props.intl.formatMessage({ id: "visualization.emptyValue" }); // TODO: RAIL-4360 replace by proper null header string id when available
    ...
    GeoChartOptionsWrapper.prototype.renderVisualization = function () {
        var _a = this.props, dataView = _a.dataView, onDataTooLarge = _a.onDataTooLarge;
        var dv = DataViewFacade["for"](dataView);
        var geoData = getGeoData(dv, this.emptyHeaderString, this.nullHeaderString);
        var validationResult = this.validateData(geoData, this.props);
        if (validationResult === null || validationResult === void 0 ? void 0 : validationResult.isDataTooLarge) {
            invariant(onDataTooLarge, "GeoChart's onDataTooLarge callback is missing.");
            onDataTooLarge();
            return null;
        }
        var geoChartOptions = this.buildGeoChartOptions(geoData, this.props);
        return React.createElement(GeoChartInner, __assign({}, this.props, { geoChartOptions: geoChartOptions }));
    };
...
export function createCategoryLegendItems(colorStrategy, emptyHeaderString, nullHeaderString) {
    ...
    return colorAssignment.map(function (item, legendIndex) {
        ...
        return {
            uri: uri !== null && uri !== void 0 ? uri : nullHeaderString,
            name: name !== null && name !== void 0 ? name : nullHeaderString,
            color: color,
