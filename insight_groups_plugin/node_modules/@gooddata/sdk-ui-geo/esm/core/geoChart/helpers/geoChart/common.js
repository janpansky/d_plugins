...
var isBucketWithItem = function (bucket) { return bucket !== undefined && !bucketIsEmpty(bucket); };
export function isLocationSet(buckets) {
    var locationBucket = bucketsFind(buckets, BucketNames.LOCATION);
    var latitudeBucket = bucketsFind(buckets, BucketNames.LATITUDE);
    var longitudeBucket = bucketsFind(buckets, BucketNames.LONGITUDE);
