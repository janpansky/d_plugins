...
function renderFluidCategoryLegend(props, contentRect) {
    ...
    var usedWidth = (contentRectClient === null || contentRectClient === void 0 ? void 0 : contentRectClient.width) ? Math.floor(contentRectClient.width) : 0;
...
function renderStaticCategoryLegend(props, contentRect, hasSizeLegend) {
    ...
    var measuredHeight = (contentRectClient === null || contentRectClient === void 0 ? void 0 : contentRectClient.height) ? Math.floor(contentRectClient.height) : 0;
