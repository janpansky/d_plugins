...
var GeoChartInner = /** @class */ (function (_super) {
    ...
    GeoChartInner.prototype.getChartProps = function (geoChartOptions) {
        ...
        var chartProps = __assign({ colorStrategy: colorStrategy,
            config: config,
            dataView: dataView, drillableItems: drillablePredicates, drillConfig: drillConfig,
            afterRender: afterRender,
            geoData: geoData,
            onCenterPositionChanged: onCenterPositionChanged,
            onZoomChanged: onZoomChanged,
            intl: intl }, (onError ? { onError: onError } : {}));
