...
export function geoValidatorHOC(InnerComponent) {
    var ValidatorHOCWrapped = /** @class */ (function (_super) {
        ...
        function ValidatorHOCWrapped(props) {
            ...
            _this.onError = function (e) {
                ...
                if (isGeoTokenMissing(e)) {
                    _this.handleInvalidMapboxToken();
                }
                else {
                    (_b = (_a = _this.props).onError) === null || _b === void 0 ? void 0 : _b.call(_a, e);
                }
            };
        ...
        ValidatorHOCWrapped.prototype.render = function () {
            ...
            return React.createElement(InnerComponent, __assign({}, this.props, { onError: this.onError }));
        };
        ValidatorHOCWrapped.prototype.shouldComponentUpdate = function (nextProps, nextState) {
        ...
        ValidatorHOCWrapped.prototype.componentDidUpdate = function (prevProps) {
            var _a, _b;
            if (((_a = prevProps.config) === null || _a === void 0 ? void 0 : _a.mapboxToken) !== ((_b = this.props.config) === null || _b === void 0 ? void 0 : _b.mapboxToken)) {
                this.setState({
                    isMapboxTokenInvalid: false
                });
            }
        ...
        ValidatorHOCWrapped.prototype.handleInvalidMapboxToken = function () {
            this.setState({
