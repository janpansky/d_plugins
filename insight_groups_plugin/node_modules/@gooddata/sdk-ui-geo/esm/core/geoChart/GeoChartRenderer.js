...
var GeoChartRenderer = /** @class */ (function (_super) {
    ...
    function GeoChartRenderer(props) {
        ...
        _this.handleMapEvent = function () {
            ...
            chart.on("error", _this.handleMapboxError);
        };
        /*
        ...
        */
        ...
        _this.handleLayerLoaded = function () {
            var chart = _this.chart;
            if (!(chart === null || chart === void 0 ? void 0 : chart.isStyleLoaded())) {
                return;
            }
        ...
        _this.handleMapboxError = function () {
    ...
    GeoChartRenderer.prototype.fullMapInit = function () {
        this.createTooltip();
        this.createMap();
