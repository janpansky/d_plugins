...
var GD_COLOR_TEXT_LIGHT = "#fff";
var GD_COLOR_TEXT = "#464e56";
export var getHigherContrastColor = function (amount, color, isDarkTheme) {
    return color && ((isDarkTheme && lighten(amount, color)) || darken(amount, color));
};
export var getLowerContrastColor = function (amount, color, isDarkTheme) {
    return color && ((isDarkTheme && darken(amount, color)) || lighten(amount, color));
};
export var getLeastContrastColor = function (color, isDarkTheme) {
    return color && setLightness(isDarkTheme ? 0.04 : 0.96, color);
};
export var mixWith0ComplementaryColor = function (amount, color, palette) { var _a; return color && mix(amount, color, ((_a = palette === null || palette === void 0 ? void 0 : palette.complementary) === null || _a === void 0 ? void 0 : _a.c0) || GD_COLOR_TEXT_LIGHT); };
export var mixWith8ComplementaryColor = function (amount, color, palette) { var _a; return color && mix(amount, color, ((_a = palette === null || palette === void 0 ? void 0 : palette.complementary) === null || _a === void 0 ? void 0 : _a.c8) || GD_COLOR_TEXT); };
var getCommonDerivedColors = function (palette, isDarkTheme) {
...
var getMessagesDerivedColors = function (palette) {
...
var getDashboardsDerivedColors = function (palette) {
...
var getButtonDerivedColors = function (palette, isDarkTheme) {
...
var getBubbleDerivedColors = function (palette) {
    var _a, _b;
    return [
...
var getDateFilterDerivedColors = function (palette, isDarkTheme) {
    var _a;
    return [
...
var getMeasureNumberFormatDialogDerivedColors = function (palette, isDarkTheme) {
    var _a;
    return [
...
var getPivotTableDerivedColors = function (palette, isDarkTheme) {
    var _a, _b;
    return [
...
var getFormDerivedColors = function (palette, isDarkTheme) {
    var _a, _b, _c;
    return [
...
var getComplementaryPaletteDerivedColors = function (palette) {
    var _a, _b;
    return [
 ...
 * @internal
 */
export var generateDerivedColors = function (palette, isDarkTheme) {
    if (!palette) {
        return [];
    }
    return __spreadArrays(getCommonDerivedColors(palette, isDarkTheme), getMessagesDerivedColors(palette), getDashboardsDerivedColors(palette), getButtonDerivedColors(palette, isDarkTheme), getBubbleDerivedColors(palette), getDateFilterDerivedColors(palette, isDarkTheme), getMeasureNumberFormatDialogDerivedColors(palette, isDarkTheme), getPivotTableDerivedColors(palette, isDarkTheme), getFormDerivedColors(palette, isDarkTheme), getComplementaryPaletteDerivedColors(palette)).filter(function (property) { return !!property; });
};
