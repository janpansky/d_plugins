...
export var ThemeProvider = function (_a) {
    var children = _a.children, themeParam = _a.theme, backendParam = _a.backend, workspaceParam = _a.workspace, _b = _a.modifier, modifier = _b === void 0 ? identity : _b, _c = _a.enableComplementaryPalette, enableComplementaryPalette = _c === void 0 ? true : _c, _d = _a.removeGlobalStylesOnUnmout, removeGlobalStylesOnUnmout = _d === void 0 ? true : _d;
    var backend = useBackend(backendParam);
    var workspace = useWorkspace(workspaceParam);
    var _e = useState(themeParam !== null && themeParam !== void 0 ? themeParam : {}), theme = _e[0], setTheme = _e[1];
