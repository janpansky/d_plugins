    ...
    function Legend() {
        ...
        _this.renderFluid = function () {
            ...
            return (React.createElement(Measure, { client: true }, function (_a) {
                ...
                var usedWidth = ((_b = contentRect.client) === null || _b === void 0 ? void 0 : _b.width) ? Math.floor(contentRect.client.width) : 0;
        ...
        _this.renderStatic = function () {
            ...
            return (React.createElement(Measure, { client: true }, function (_a) {
                var _b;
                var measureRef = _a.measureRef, contentRect = _a.contentRect;
                var measuredHeight = ((_b = contentRect.client) === null || _b === void 0 ? void 0 : _b.height) ? Math.floor(contentRect.client.height)
                    : 0;
