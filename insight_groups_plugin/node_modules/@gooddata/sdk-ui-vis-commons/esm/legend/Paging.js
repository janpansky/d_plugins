...
function renderPagingButton(type, buttonsOrientation, handler, disabled) {
    var classes = cx("gd-button-link", "gd-button-icon-only", "gd-icon-chevron-" + getbuttonIcoStyle(type, buttonsOrientation), "paging-button");
 ...
 * @internal
 */
export var Paging = function (props) {
    var page = props.page, pagesCount = props.pagesCount, _a = props.buttonsOrientation, buttonsOrientation = _a === void 0 ? "upDown" : _a, showNextPage = props.showNextPage, showPrevPage = props.showPrevPage;
