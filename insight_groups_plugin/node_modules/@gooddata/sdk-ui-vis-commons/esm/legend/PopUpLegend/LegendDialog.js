...
var LegendDialogWrapper = function (_a) {
    var children = _a.children;
    var isMobile = useMediaQuery("<sm");
    return children(isMobile);
};
var LegendDialogContent = function (props) {
    var title = props.title, onCloseDialog = props.onCloseDialog, children = props.children;
...
export var LegendDialog = function (props) {
    var name = props.name, children = props.children, isOpen = props.isOpen, alignTo = props.alignTo, onCloseDialog = props.onCloseDialog;
    if (!isOpen) {
        return null;
    }
    return (React.createElement(LegendDialogWrapper, null, function (isMobile) {
