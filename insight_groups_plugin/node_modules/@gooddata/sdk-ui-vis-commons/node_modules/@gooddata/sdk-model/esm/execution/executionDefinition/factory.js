...
function defaultDimensionsWithBuckets(buckets) {
    ...
    var firstDim = bucketAttributes(firstBucket);
    var secondDim = bucketsAttributes(otherBuckets);
    return bucketMeasures(firstBucket).length
        ? newTwoDimensional(__spreadArrays(firstDim, [MeasureGroupIdentifier]), secondDim)
        : newTwoDimensional(firstDim, __spreadArrays(secondDim, [MeasureGroupIdentifier]));
}
