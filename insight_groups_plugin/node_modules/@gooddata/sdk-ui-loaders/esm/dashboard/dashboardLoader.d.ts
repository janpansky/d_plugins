...
import { AdaptiveLoadOptions, IDashboardBasePropsForLoader, IDashboardLoadOptions, IDashboardPluginsLoaderOptions, LoadedPlugin, IEmbeddedPlugin } from "./types";
/**
 * @public
 */
export declare type DashboardEngineLoader = (dashboard: IDashboardWithReferences | undefined) => Promise<IDashboardEngine>;
/**
 * @public
 */
export declare type DashboardPluginsLoader = (ctx: DashboardContext, dashboard: IDashboardWithReferences | undefined, options?: IDashboardPluginsLoaderOptions) => Promise<LoadedPlugin[]>;
/**
 * @public
 */
export declare type DashboardBeforeLoad = (ctx: DashboardContext, dashboard: IDashboardWithReferences | undefined) => Promise<void>;
/**
 * @public
 */
