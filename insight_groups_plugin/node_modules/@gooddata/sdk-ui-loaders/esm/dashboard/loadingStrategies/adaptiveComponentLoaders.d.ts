 ...
 * @internal
 */
export declare const adaptiveDashboardPluginLoaderFactory: (moduleFederationIntegration: ModuleFederationIntegration) => (ctx: DashboardContext, dashboard: IDashboardWithReferences | undefined, options?: IDashboardPluginsLoaderOptions | undefined) => Promise<LoadedPlugin[]>;
/**
 * Adaptive loader will check if there are any plugins linked with the dashboard. If so, it will use
