 ...
 * does not have
 */
export var defaultDateFilterConfig = {
    ...
    relativePresets: Object.keys(DateFilterHelpers.defaultDateFilterOptions.relativePreset).reduce(function (presets, granularityKey) {
        var granularityPresets = DateFilterHelpers.defaultDateFilterOptions.relativePreset[granularityKey];
        presets.push.apply(presets, __spread(granularityPresets));
        return presets;
    }, []),
    absolutePresets: [],
};
