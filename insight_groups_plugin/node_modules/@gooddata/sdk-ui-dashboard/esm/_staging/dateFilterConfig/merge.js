...
var shouldHideRelativePreset = function (preset, dashboardConfig) {
    var _a, _b;
    var hideForGranularity = (_a = dashboardConfig.hideGranularities) === null || _a === void 0 ? void 0 : _a.includes(preset.granularity);
    var hideForId = (_b = dashboardConfig.hideOptions) === null || _b === void 0 ? void 0 : _b.includes(preset.localIdentifier);
