import { IAbsoluteDateFilterPreset, IRelativeDateFilterPreset, IAllTimeDateFilterOption, IDashboardDateFilter } from "@gooddata/sdk-model";
import { DateFilterOption, IDateFilterOptionsByType, IUiAbsoluteDateFilterForm, IUiRelativeDateFilterForm } from "@gooddata/sdk-ui-filters";
...
export declare function findDateFilterOptionByValue(dateFilter: IDashboardDateFilter, dateFilterOptions: IDateFilterOptionsByType): IAbsoluteDateFilterPreset | IRelativeDateFilterPreset | IAllTimeDateFilterOption | IUiAbsoluteDateFilterForm | IUiRelativeDateFilterForm | undefined;
export {};
