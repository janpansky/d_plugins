import { ObjRef, ICatalogAttribute, ICatalogDateAttribute } from "@gooddata/sdk-model";
 ...
 * @internal
 */
export declare const selectConfiguredDrillsByWidgetRef: (ref: ObjRef) => import("@reduxjs/toolkit").OutputSelector<import("..").DashboardState, IImplicitDrillWithPredicates[], (res1: import("@gooddata/sdk-model").IDrillToLegacyDashboard[] | import("@gooddata/sdk-model").InsightDrillDefinition[], res2: boolean, res3: boolean, res4: boolean, res5: boolean, res6: boolean, res7: boolean, res8: boolean) => IImplicitDrillWithPredicates[]>;
/**
 * @internal
 */
export declare const selectValidConfiguredDrillsByWidgetRef: (ref: ObjRef) => import("@reduxjs/toolkit").OutputSelector<import("..").DashboardState, IImplicitDrillWithPredicates[], (res1: IImplicitDrillWithPredicates[], res2: import("../../..").ObjRefMap<import("@gooddata/sdk-model").IAttributeDisplayFormMetadataObject>, res3: import("../../..").ObjRefMap<import("@gooddata/sdk-model").IListedDashboard>, res4: import("../../..").ObjRefMap<import("@gooddata/sdk-model").IInsight>) => IImplicitDrillWithPredicates[]>;
/**
 * @internal
 */
