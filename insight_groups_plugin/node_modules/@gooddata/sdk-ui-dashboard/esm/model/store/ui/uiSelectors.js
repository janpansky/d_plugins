 ...
 * @alpha
 */
export var selectScheduleEmailDialogDefaultAttachment = createSelector(selectSelf, function (state) { return state.scheduleEmailDialog.defaultAttachmentRef; });
/**
 * @alpha
 */
 ...
 * @internal
 */
export var selectRenderMode = createSelector(selectSelf, function (state) { return state.renderMode; });
/**
 * @internal
 */
export var selectIsInViewMode = createSelector(selectSelf, function (state) { return state.renderMode === "view"; });
/**
 * @internal
 */
export var selectIsInEditMode = createSelector(selectSelf, function (state) { return state.renderMode === "edit"; });
/**
 * @internal
 */
export var selectActiveHeaderIndex = createSelector(selectSelf, function (state) { return state.activeHeaderIndex; });
/**
 * @internal
 */
