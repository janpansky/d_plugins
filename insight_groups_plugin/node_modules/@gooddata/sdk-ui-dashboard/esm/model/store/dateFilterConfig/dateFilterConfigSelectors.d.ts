 ...
 * @alpha
 */
export declare const selectDateFilterConfigOverrides: import("@reduxjs/toolkit").OutputSelector<DashboardState, import("@gooddata/sdk-model").IDashboardDateFilterConfig | undefined, (res: import("./dateFilterConfigState").DateFilterConfigState) => import("@gooddata/sdk-model").IDashboardDateFilterConfig | undefined>;
/**
 ...
 * @alpha
 */
export declare const selectEffectiveDateFilterConfig: import("@reduxjs/toolkit").OutputSelector<DashboardState, import("@gooddata/sdk-model").IDateFilterConfig, (res: import("./dateFilterConfigState").DateFilterConfigState) => import("@gooddata/sdk-model").IDateFilterConfig>;
/**
 ...
 * @alpha
 */
export declare const selectEffectiveDateFilterOptions: import("@reduxjs/toolkit").OutputSelector<DashboardState, IDateFilterOptionsByType, (res: import("@gooddata/sdk-model").IDateFilterConfig) => IDateFilterOptionsByType>;
/**
 ...
 * @alpha
 */
export declare const selectEffectiveDateFilterAvailableGranularities: import("@reduxjs/toolkit").OutputSelector<DashboardState, DateFilterGranularity[], (res: import("@gooddata/sdk-model").IDateFilterConfig) => DateFilterGranularity[]>;
/**
 ...
 * @alpha
 */
export declare const selectEffectiveDateFilterTitle: import("@reduxjs/toolkit").OutputSelector<DashboardState, string | undefined, (res1: boolean, res2: import("@gooddata/sdk-model").IDashboardDateFilterConfig | undefined) => string | undefined>;
/**
 ...
 * @alpha
 */
export declare const selectEffectiveDateFilterMode: import("@reduxjs/toolkit").OutputSelector<DashboardState, DashboardDateFilterConfigMode, (res1: boolean, res2: import("@gooddata/sdk-model").IDashboardDateFilterConfig | undefined) => DashboardDateFilterConfigMode>;
/**
 ...
 * @alpha
 */
export declare const selectDateFilterConfigValidationWarnings: import("@reduxjs/toolkit").OutputSelector<DashboardState, import("../../..").DateFilterValidationResult[], (res: import("./dateFilterConfigState").DateFilterConfigState) => import("../../..").DateFilterValidationResult[]>;
