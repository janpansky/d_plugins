...
export function changeLayoutSectionHeaderHandler(ctx, cmd) {
    var layout, _a, index, header, mergeHeaders, existingHeader, newHeader, sanitizedHeader;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                sanitizedHeader = sanitizeHeader(newHeader);
            ...
            case 2:
                _c.sent();
                return [2 /*return*/, layoutSectionHeaderChanged(ctx, sanitizedHeader, index, cmd.correlationId)];
        }
    });
}
