...
import { dashboardDateFilterToDateFilterByWidget, dashboardAttributeFilterToAttributeFilter, } from "../../../converters";
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 1:
                // put start event
                _d.sent();
                return [4 /*yield*/, select(selectAnalyticalWidgetByRef(cmd.payload.drillEvent.widgetRef))];
            case 2:
                widget = _d.sent();
            ...
            case 11:
                ...
                drillIntersectionFilters = convertIntersectionToAttributeFilters(cmd.payload.drillEvent.drillContext.intersection, dateAttributes.map(function (dA) { return dA.attribute.ref; }), (_c = ctx.backend.capabilities.supportsElementUris) !== null && _c !== void 0 ? _c : true);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                filters = filterContextItems.map(dashboardAttributeFilterToAttributeFilter);
...
export function convertIntersectionToAttributeFilters(intersection, dateDataSetsAttributesRefs, backendSupportsElementUris) {
    return intersection
