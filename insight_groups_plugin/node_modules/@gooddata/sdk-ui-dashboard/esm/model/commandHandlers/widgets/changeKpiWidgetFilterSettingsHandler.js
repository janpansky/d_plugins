...
import { validateAttributeFiltersToIgnore, validateDatasetForKpiWidgetDateFilter, } from "./validation/filterValidation";
import { kpiWidgetFilterSettingsChanged } from "../../events/kpi";
var KpiWidgetFilterValidations = {
...
export function changeKpiWidgetFilterSettingsHandler(ctx, cmd) {
    var widgets, kpiWidget, result, dateDataSet, ignoredFilters, ignoreDashboardFilters;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, call(processFilterOp, ctx, KpiWidgetFilterValidations, cmd, kpiWidget)];
            case 2:
                result = _a.sent();
            ...
            case 3:
                _a.sent();
                return [2 /*return*/, kpiWidgetFilterSettingsChanged(ctx, kpiWidget.ref, ignoredFilters !== null && ignoredFilters !== void 0 ? ignoredFilters : [], result.dateDataSet, cmd.correlationId)];
        }
    });
}
