...
import { selectAttributeFilterDisplayFormsMap, selectFilterContextAttributeFilterByLocalId, selectFilterContextAttributeFilters, } from "../../../store/filterContext/filterContextSelectors";
...
export function setAttributeFilterParentsHandler(ctx, cmd) {
    var _a, filterLocalId, parentFilters, allFilters, affectedFilter, displayFormsMap, validationResult, message, changedFilter;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, call(validateAttributeFilterParents, ctx, affectedFilter, __spread(parentFilters), allFilters, displayFormsMap)];
            case 4:
