...
export function validateAttributeFilterParents(ctx, dashboardFilter, parents, allFilters, displayFormsMap) {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    parentValidationData = parents.map(function (parent) {
                        ...
                        var parentAttribute = (_a = displayFormsMap.get(parentFilter.attributeFilter.displayForm)) === null || _a === void 0 ? void 0 : _a.attribute;
                        var dashboardFilterAttribute = (_b = displayFormsMap.get(dashboardFilter.attributeFilter.displayForm)) === null || _b === void 0 ? void 0 : _b.attribute;
                    ...
                    if (parentValidationData.some(function (parent) { return parent === undefined; })) {
                        return [2 /*return*/, "INVALID_METADATA"];
                    }
