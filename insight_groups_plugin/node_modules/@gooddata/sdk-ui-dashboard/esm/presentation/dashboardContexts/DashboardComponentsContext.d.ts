...
import { CustomButtonBarComponent, CustomMenuButtonComponent, CustomTitleComponent, CustomTopBarComponent } from "../topBar/types";
import { CustomScheduledEmailDialogComponent, CustomScheduledEmailManagementDialogComponent } from "../scheduledEmail/types";
...
import { AttributeFilterComponentProvider, InsightBodyComponentProvider, InsightComponentProvider, InsightMenuButtonComponentProvider, InsightMenuComponentProvider, KpiComponentProvider, WidgetComponentProvider } from "./types";
 ...
 * @internal
 */
export declare const useDashboardComponentsContext: (localComponentOverrides?: Partial<IDashboardComponentsContext> | undefined) => IDashboardComponentsContext;
/**
 * @internal
 */
...
export {};
//# sourceMappingURL=DashboardComponentsContext.d.ts.map