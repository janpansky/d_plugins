...
export var Input = function (props) {
    var _a = props.className, className = _a === void 0 ? "" : _a, label = props.label, maxlength = props.maxlength, placeholder = props.placeholder, value = props.value, onChange = props.onChange;
    var classNames = "gd-input-component " + className;
