 ...
 * @internal
 */
export declare type IScheduleEmailRecipient = IScheduleEmailExternalRecipient | IScheduleEmailExistingRecipient;
/**
 * @internal
 */
...
export declare type WidgetExportFileFormat = "csv" | "xlsx";
