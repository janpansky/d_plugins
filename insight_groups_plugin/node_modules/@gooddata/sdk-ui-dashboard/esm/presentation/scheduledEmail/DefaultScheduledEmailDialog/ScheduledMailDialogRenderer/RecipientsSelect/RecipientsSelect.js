...
export var RecipientsSelect = function (props) {
    var backend = props.backend, workspace = props.workspace, author = props.author, currentUser = props.currentUser, value = props.value, originalValue = props.originalValue, onChange = props.onChange, onError = props.onError, canListUsersInProject = props.canListUsersInProject, enableKPIDashboardScheduleRecipients = props.enableKPIDashboardScheduleRecipients, allowEmptySelection = props.allowEmptySelection;
    ...
    return (React.createElement(RecipientsSelectRenderer, { canListUsersInProject: canListUsersInProject, isMulti: enableKPIDashboardScheduleRecipients, options: options, value: value, originalValue: originalValue, onChange: onChange, author: author, currentUser: currentUser, onLoad: function (queryOptions) {
