...
export var DefaultMenuButton = function (props) {
    ...
    var visibleMenuItems = useMemo(function () { return menuItems.filter(function (item) { return item.visible !== false; }); }, [menuItems]);
    ...
    var renderMenuItems = function () {
        return (React.createElement(Overlay, { key: "topBarMenuButton", alignTo: ".s-header-options-button", alignPoints: overlayAlignPoints, className: "gd-header-menu-overlay", closeOnMouseDrag: true, closeOnOutsideClick: true, onClose: onMenuButtonClick },
            React.createElement(ItemsWrapper, { smallItemsSpacing: true }, visibleMenuItems.map(function (menuItem) {
                var _a;
                ...
                var body = (React.createElement(SingleSelectListItem, { className: cx("gd-menu-item", menuItem.className, "s-" + menuItem.itemId, (_a = {},
