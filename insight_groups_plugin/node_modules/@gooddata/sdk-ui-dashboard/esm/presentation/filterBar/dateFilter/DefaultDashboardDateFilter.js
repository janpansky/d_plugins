...
import { selectBackendCapabilities, selectLocale, selectSettings, useDashboardSelector, } from "../../../model";
/**
...
export var DefaultDashboardDateFilter = function (props) {
    ...
    return (React.createElement(DateFilter, { excludeCurrentPeriod: excludeCurrentPeriod, selectedFilterOption: dateFilterOption, dateFilterMode: readonly ? "readonly" : "active", filterOptions: config.dateFilterOptions, availableGranularities: config.availableGranularities, customFilterName: config.customFilterName, onApply: onApply, dateFormat: settings.responsiveUiDateFormat, locale: locale, isTimeForAbsoluteRangeEnabled: !!capabilities.supportsTimeGranularities }));
};
