 ...
 * @internal
 */
export declare function useKpiData({ kpiWidget, dashboardFilters, backend, workspace, }: IUseKpiDataConfig): UseCancelablePromiseState<IUseKpiDataResult, GoodDataSdkError>;
export {};
