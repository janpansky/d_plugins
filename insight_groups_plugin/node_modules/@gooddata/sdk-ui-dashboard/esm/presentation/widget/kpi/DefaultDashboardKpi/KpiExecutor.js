...
import { isMeasureFormatInPercent, measureLocalId, objRefToString, widgetRef, } from "@gooddata/sdk-model";
...
var KpiExecutorCore = function (props) {
    ...
    var alertSavingStatus = kpiAlertOperations.creatingStatus === "inProgress" ||
        ...
        : kpiAlertOperations.creatingStatus === "error" || kpiAlertOperations.updatingStatus === "error"
            ? "error"
            : "idle";
    var _d = useWidgetSelection(kpiWidget.ref), isSelectable = _d.isSelectable, isSelected = _d.isSelected, onSelected = _d.onSelected;
