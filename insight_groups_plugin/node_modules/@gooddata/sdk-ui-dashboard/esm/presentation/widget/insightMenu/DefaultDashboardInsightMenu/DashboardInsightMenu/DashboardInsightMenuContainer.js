...
var itemsWrapperStyle = { width: "100%" };
export var DashboardInsightMenuContainer = function (props) {
    return (React.createElement("div", { className: "insight-configuration" },
        React.createElement("div", { className: "insight-configuration-panel-header" },
            React.createElement(DashboardInsightMenuHeader, { widget: props.widget, title: widgetTitle(props.widget) }),
