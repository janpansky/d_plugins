...
export declare function useDrills({ onDrill, onDrillSuccess, onDrillError, onDrillDown, onDrillDownSuccess, onDrillDownError, onDrillToInsight, onDrillToInsightSuccess, onDrillToInsightError, onDrillToDashboard, onDrillToDashboardSuccess, onDrillToDashboardError, onDrillToAttributeUrl, onDrillToAttributeUrlSuccess, onDrillToAttributeUrlError, onDrillToCustomUrl, onDrillToCustomUrlSuccess, onDrillToCustomUrlError, onDrillToLegacyDashboard, onDrillToLegacyDashboardSuccess, onDrillToLegacyDashboardError, onError, }: UseDrillsProps): {
    ...
    drillToInsight: {
        run: (drillDefinition: import("@gooddata/sdk-model").IDrillToInsight, drillEvent: import("../../..").IDashboardDrillEvent, correlationId?: string | undefined) => void;
        status?: "running" | "error" | "success" | undefined;
    };
    drillToDashboard: {
        run: (drillDefinition: import("@gooddata/sdk-model").IDrillToDashboard, drillEvent: import("../../..").IDashboardDrillEvent, correlationId?: string | undefined) => void;
        status?: "running" | "error" | "success" | undefined;
    };
    drillToAttributeUrl: {
        run: (drillDefinition: import("@gooddata/sdk-model").IDrillToAttributeUrl, drillEvent: import("../../..").IDashboardDrillEvent, correlationId?: string | undefined) => void;
        status?: "running" | "error" | "success" | undefined;
    };
    drillToCustomUrl: {
        run: (drillDefinition: import("@gooddata/sdk-model").IDrillToCustomUrl, drillEvent: import("../../..").IDashboardDrillEvent, correlationId?: string | undefined) => void;
        status?: "running" | "error" | "success" | undefined;
    };
    drillToLegacyDashboard: {
        run: (drillDefinition: import("@gooddata/sdk-model").IDrillToLegacyDashboard, drillEvent: import("../../..").IDashboardDrillEvent, correlationId?: string | undefined) => void;
        status?: "running" | "error" | "success" | undefined;
    };
};
