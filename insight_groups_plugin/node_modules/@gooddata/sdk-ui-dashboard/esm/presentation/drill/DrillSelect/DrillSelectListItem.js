...
var DRILL_ICON_NAME = (_a = {},
    _a[DrillType.DRILL_TO_DASHBOARD] = "DrillToDashboard",
    _a[DrillType.DRILL_TO_INSIGHT] = "DrillToInsight",
    _a[DrillType.DRILL_TO_URL] = "Hyperlink",
    _a[DrillType.DRILL_DOWN] = "DrillDown",
    _a);
export var DrillSelectListItem = function (props) {
    var _a, _b;
    var theme = useTheme(props.theme);
    var _c = props.item, name = _c.name, type = _c.type, drillDefinition = _c.drillDefinition, attributeValue = _c.attributeValue;
    ...
    var itemClassName = cx("gd-drill-modal-picker-list-item", "s-gd-drill-modal-picker-item", "s-" + type);
    var IconComponent = Icon[DRILL_ICON_NAME[type]];
    var attributeLabel = attributeValue ? "(" + attributeValue + ")" : "";
    // make sure there is no trailing space in case attributeLabel is empty
    var title = compact([name, attributeLabel]).join(" ");
