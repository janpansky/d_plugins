...
import { DashboardLayoutItemModifications } from "./DefaultDashboardLayoutRenderer";
/**
 ...
 */
export declare const getMemoizedWidgetSanitizer: <TWidget>(cache: LRUCache<IDashboardLayoutItem<TWidget>>) => (getInsightByRef: (insightRef: ObjRef) => IInsight | undefined, enableKDWidgetCustomHeight: boolean) => DashboardLayoutItemModifications<TWidget>;
/**
