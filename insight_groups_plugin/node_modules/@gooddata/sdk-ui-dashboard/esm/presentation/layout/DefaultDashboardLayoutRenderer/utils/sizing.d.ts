import { IInsightDefinition, AnalyticalWidgetType, IDashboardLayout, IDashboardLayoutSize, IDashboardLayoutItem, ScreenSize, ISettings, IKpi } from "@gooddata/sdk-model";
 ...
 * @internal
 */
export declare type MeasurableWidgetContent = IInsightDefinition | IKpi;
