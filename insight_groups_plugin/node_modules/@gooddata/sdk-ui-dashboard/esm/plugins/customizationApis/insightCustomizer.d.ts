...
import { CustomDashboardInsightComponent, InsightComponentProvider, InsightBodyComponentProvider, OptionalInsightComponentProvider, OptionalInsightBodyComponentProvider } from "../../presentation";
...
export declare class DefaultInsightCustomizer implements IDashboardInsightCustomizer {
    ...
    private state;
    constructor(logger: IDashboardCustomizationLogger, defaultCoreProvider?: InsightComponentProvider, defaultInsightBodyProvider?: InsightBodyComponentProvider);
