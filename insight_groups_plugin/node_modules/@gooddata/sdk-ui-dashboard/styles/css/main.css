...
.gd-date-range-picker .gd-input-field,
.gd-date-range-picker .input-text {
  font-size: 13px; }
...
.add-attribute-filter-dropdown > div {
  margin-left: -10px; }
...
.attribute-filter-dropdown-configuration .configuration-item-title {
  display: flex;
  flex-grow: 0; }
  .attribute-filter-dropdown-configuration .configuration-item-title .addon {
    flex-shrink: 0;
    color: var(--gd-palette-complementary-6, #94a1ad);
    margin-right: 3px;
