 ...
 * @alpha
 */
export declare const isUserAccess: (obj: unknown) => obj is m.IUserAccess;
/**
 ...
 * @alpha
 */
export declare const isUserGroupAccess: (obj: unknown) => obj is m.IUserGroupAccess;
/**
 ...
 * @alpha
 */
export declare type AccessGranteeDetail = IUserAccess | IUserGroupAccess;
/**
 ...
 * @public
 */
export declare const isUserAccessGrantee: (obj: unknown) => obj is m.IUserAccessGrantee;
/**
 ...
 * @public
 */
export declare const isUserGroupAccessGrantee: (obj: unknown) => obj is m.IUserGroupAccessGrantee;
/**
 ...
 * @public
 */
export declare type IAccessGrantee = m.IAccessGrantee;
