...
.gd-visualizations-list-item .gd-vis-type-container {
  flex: 0 0 32px;
}
.gd-visualizations-list-item .gd-visualizations-list-item-description {
  flex: 0 0 15px;
  padding-top: 8px;
  padding-left: 10px;
}
...
.gd-visualizations-list-item .gd-visualizations-list-item-actions:hover {
  background: var(--gd-palette-error-lightest, #fff2f1);
}
.gd-visualizations-list-item .gd-visualizations-list-item-actions:hover ~ .gd-visualizations-list-item-content {
  background: var(--gd-palette-error-lightest, #fff2f1);
}
.gd-visualizations-list-item .gd-visualizations-list-item-actions:hover ~ .gd-visualizations-list-item-description {
  background: var(--gd-palette-error-lightest, #fff2f1);
}
.gd-visualizations-list-item .gd-visualizations-list-item-actions:hover ~ .gd-vis-type-container {
  background: var(--gd-palette-error-lightest, #fff2f1);
}
.gd-visualizations-list-item .gd-visualizations-list-item-actions:hover .gd-visualizations-list-item-action-delete::before {
  color: var(--gd-palette-error-base, #e54d42);
}
...
.gd-visualizations-list-item:hover .gd-visualizations-list-item-description {
  opacity: 1;
}
...
.gd-header-menu-vertical-content .gd-header-expiration-date {
  font-size: 16px;
  line-height: 20px;
  margin-bottom: 10px;
}
.gd-header-menu-vertical-content .gd-button-primary.gd-upsell-button {
  display: flex;
  justify-content: center;
  height: 33px;
  margin-top: 4px;
}
.gd-header-menu-vertical-content .gd-button-primary.gd-upsell-button .gd-icon-star {
  margin-top: 4px;
}
.gd-header-menu-vertical-content .gd-button-primary.gd-upsell-button.gd-button-small {
  font-size: 14px;
  line-height: 14px;
}
.gd-header-menu-vertical-content .gd-header-expiration-date,
...
.gd-granular-permissions-admin-information {
  width: 100%;
  margin-top: 10px;
}
.gd-granular-permissions-admin-information .gd-message-text {
  display: flex;
  justify-content: space-between;
}
...
.gd-share-dialog-grantee-item:hover, .gd-share-dialog-grantee-item.is-active {
  background: var(--gd-palette-complementary-2, #ebeff4);
}
.gd-share-dialog-grantee-item:hover .gd-grantee-item-icon-right, .gd-share-dialog-grantee-item.is-active .gd-grantee-item-icon-right {
  display: block;
}
.gd-share-dialog-grantee-item .gd-grantee-granular-permission {
  display: flex;
  align-items: center;
  margin-right: 10px;
}
.gd-share-dialog-grantee-item .gd-grantee-granular-permission-bubble-trigger {
  display: flex;
}
...
.gd-share-dialog-grantee-item .gd-granular-permission-button:hover {
  cursor: pointer;
  background-color: var(--gd-palette-complementary-0, #fff);
...
.gd-share-dialog-grantee-item .gd-granular-permission-button.is-active {
  ...
  background-color: var(--gd-palette-complementary-2, #ecf0f5);
}
.gd-share-dialog-grantee-item .gd-granular-permission-button .gd-granular-permission-button-title {
  margin-right: 6px;
  font-size: 14px;
  font-weight: normal;
  line-height: 20px;
}
.gd-share-dialog-grantee-item .gd-granular-permission-button::after {
  margin-top: 2px;
}

.gd-granular-permissions-remove {
  border-top: 1px solid var(--gd-palette-complementary-3, #dde4eb);
}
...
.gd-styling-editor-dialog-header-back-button {
  padding-right: 15px;
}
.gd-styling-editor-dialog-header-title {
  color: var(--gd-palette-complementary-8, #464e56);
}
...
.gd-description-panel-bubble.bubble-light {
  max-width: 220px;
}
.gd-description-panel-bubble.bubble-light .bubble-content {
  padding: 0;
}
...
.gd-icon-circle-question-wrapper .gd-icon-circle-question {
  margin-top: 1px;
  color: var(--gd-palette-complementary-7, #687581);
}
.gd-icon-circle-question-wrapper:hover .gd-icon-circle-question {
  color: var(--gd-palette-complementary-8, #464e56);
}

.gd-description-panel {
  box-sizing: border-box;
  display: flex;
  flex-direction: column;
  gap: 10px;
...
.gd-ellipsis-text-fixed {
  width: 188px;
}
.gd-ellipsis-text-button {
  background: none;
  border: none;
  padding: 0;
  font: inherit;
...
.gd-metadata-list-title {
  font-size: 10px;
  line-height: 14px;
  color: var(--gd-palette-complementary-6, #94a1ad);
  text-transform: uppercase;
}
.gd-metadata-list-element {
  display: flex;
  flex-direction: row;
  align-items: center;
  font-size: 12px;
...
.gd-metadata-list-element span {
  overflow: hidden;
  text-overflow: ellipsis;
}
.gd-metadata-list-icon {
  color: var(--gd-palette-complementary-6, #94a1ad);
  cursor: help;
  flex-shrink: 0;
  margin-left: 5px;
...
.gd-setting-item-container.divider {
  border-bottom: 1px solid #dde4eb;
}

.gd-setting-item-title {
  display: flex;
  flex: 1;
  max-width: 55%;
  margin-right: 20px;
...
.gd-setting-item-title .icon-circle-question {
  margin-left: 5px;
  font-size: 12px;
  color: #94a1ad;
}

.gd-setting-item-state {
  flex: 1;
  display: flex;
  flex-direction: row;
  align-items: center;
...
.gd-setting-item-state .gd-setting-item-value {
  white-space: nowrap;
  overflow: hidden;
  text-overflow: ellipsis;
  color: #687581;
...
.gd-setting-item-state .gd-setting-item-action {
  flex: initial;
  margin-left: 20px;
}
.gd-setting-item-state .gd-setting-item-action .gd-button-link-dimmed.gd-button {
  padding: 0;
}
