        ...
        return (React.createElement("div", { className: "color-picker-container", "aria-label": "Color picker" },
            ...
            React.createElement("div", { className: "color-picker-control-wrapper" },
                ...
                React.createElement("div", { className: "color-picker-buttons-wrapper" },
                    ...
                    React.createElement(Button, { value: intl.formatMessage({ id: "gs.color-picker.okButton" }), disabled: isEqual(this.props.initialRgbColor, getRgbFromHslColor(this.state.draftHslColor)), className: "gd-button-action gd-button color-picker-ok-button", onClick: function () { return _this.props.onSubmit(getRgbFromHslColor(_this.state.draftHslColor)); } })))));
    };
