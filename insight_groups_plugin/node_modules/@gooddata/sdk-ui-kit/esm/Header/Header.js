...
var AppHeaderCore = /** @class */ (function (_super) {
    ...
    function AppHeaderCore(props) {
        ...
        _this.getTrialCountdown = function (expiredDate) {
            ...
            var trialDaysLeft = differenceInCalendarDays(new Date(expiredDate), new Date()) + 1;
            if (trialDaysLeft === 1) {
        ...
        _this.renderMobileNav = function () {
            ...
            return (React.createElement(React.Fragment, null,
                ...
                _this.state.isOverlayMenuOpen ? _this.renderOverlayMenu() : null));
        };
        ...
        _this.renderTrialItems = function () {
            if (_this.props.expiredDate || _this.props.showUpsellButton) {
                return (React.createElement("div", { className: "gd-header-menu-trial gd-header-measure" },
                    _this.props.expiredDate ? (React.createElement("div", { className: "gd-header-expiration-date" }, _this.getTrialCountdown(_this.props.expiredDate))) : null,
                    _this.props.showUpsellButton ? (React.createElement(HeaderUpsellButton, { onUpsellButtonClick: _this.props.onUpsellButtonClick })) : null));
            }
            return null;
        };
        ...
        _this.renderStandardNav = function () {
            var _a = _this.props, badges = _a.badges, helpMenuDropdownAlignPoints = _a.helpMenuDropdownAlignPoints, headerTextColor = _a.headerTextColor, headerColor = _a.headerColor;
            var textColor = getTextColor(headerTextColor, headerColor);
            return (React.createElement("div", { className: "gd-header-stretch gd-header-menu-wrapper" },
                ...
                _this.renderTrialItems(),
                _this.props.helpMenuItems.length ? (React.createElement(HeaderHelp, { onMenuItemClick: _this.props.onMenuItemClick, className: "gd-header-measure", helpMenuDropdownAlignPoints: helpMenuDropdownAlignPoints, items: _this.props.helpMenuItems, disableDropdown: _this.props.disableHelpDropdown, onHelpClicked: _this.props.onHelpClick, helpRedirectUrl: _this.props.helpRedirectUrl })) : null,
                _this.props.showInviteItem ? (React.createElement(HeaderInvite, { onInviteItemClick: _this.props.onInviteItemClick, textColor: textColor })) : null,
