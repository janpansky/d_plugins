...
export var DropdownButton = function (_a) {
    var id = _a.id, className = _a.className, value = _a.value, _b = _a.title, title = _b === void 0 ? value : _b, disabled = _a.disabled, isOpen = _a.isOpen, _c = _a.isSmall, isSmall = _c === void 0 ? true : _c, iconLeft = _a.iconLeft, onClick = _a.onClick;
    var buttonClasses = cx("gd-button-primary", "button-dropdown", "dropdown-button", {
