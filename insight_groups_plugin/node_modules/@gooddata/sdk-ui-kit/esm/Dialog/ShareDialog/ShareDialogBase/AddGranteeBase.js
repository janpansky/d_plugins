...
export var AddGranteeBase = function (props) {
    var appliedGrantees = props.appliedGrantees, addedGrantees = props.addedGrantees, currentUser = props.currentUser, isDirty = props.isDirty, currentUserPermissions = props.currentUserPermissions, sharedObject = props.sharedObject, onCancel = props.onCancel, onSubmit = props.onSubmit, onBackClick = props.onBackClick, onAddUserOrGroups = props.onAddUserOrGroups, onDelete = props.onDelete, onGranularGranteeChange = props.onGranularGranteeChange;
    var intl = useIntl();
    var isSharedObjectLocked = sharedObject.isLocked, sharedObjectRef = sharedObject.ref, areGranularPermissionsSupported = sharedObject.areGranularPermissionsSupported;
