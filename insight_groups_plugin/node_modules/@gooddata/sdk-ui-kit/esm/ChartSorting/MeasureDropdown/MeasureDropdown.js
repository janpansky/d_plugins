...
var getItems = function (intl, measures, measureNames, areaSortEnabled, availableId) {
    ...
    if (measures) {
        measures.forEach(function (measure) {
            ...
            var bucketItem = measureNames[measureLocator.measureLocatorItem.measureIdentifier];
            if (bucketItem) {
                measureValues.push({
...
export var MeasureDropdown = function (_a) {
    ...
    return (React.createElement("div", { className: "sort-measure-section" },
        ...
        React.createElement("div", { className: "measure-sorting-dropdown" }, disableDropdown ? (React.createElement(BubbleHoverTrigger, null,
            ...
            disabledExplanationTooltip ? (React.createElement(Bubble, { alignPoints: [{ align: "cr cl" }, { align: "cl cr" }] })) : null)) : (React.createElement(Dropdown, { className: "gd-measure-sorting-dropdown-body s-measure-sorting-dropdown-body", closeOnMouseDrag: true, closeOnParentScroll: true, renderButton: function (_a) {
