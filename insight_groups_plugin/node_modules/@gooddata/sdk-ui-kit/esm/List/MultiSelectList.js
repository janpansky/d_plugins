...
var MultiSelectListCore = /** @class */ (function (_super) {
    ...
    MultiSelectListCore.prototype.render = function () {
        var _this = this;
        var _a = this.props, isMobile = _a.isMobile, width = _a.width, height = _a.height, items = _a.items, itemHeight = _a.itemHeight, itemsCount = _a.itemsCount, onScrollEnd = _a.onScrollEnd, renderItem = _a.renderItem, selectedItems = _a.selectedItems, listClassNames = _a.listClassNames;
        var classNames = cx("is-multiselect", listClassNames ? listClassNames : "");
        return (React.createElement("div", { className: "gd-flex-item-stretch-mobile gd-flex-row-container-mobile" },
            ...
            React.createElement(FlexDimensions, { measureHeight: isMobile, measureWidth: isMobile || !width, className: "gd-flex-item-stretch-mobile" },
                React.createElement(List, { className: classNames, width: width, height: height, items: items, itemHeight: itemHeight, itemsCount: itemsCount, renderItem: function (_a) {
                        var item = _a.item;
                        return renderItem({
                            item: item,
                            isSelected: _this.props.isSelected
                                ? _this.props.isSelected(item)
                                : selectedItems.some(function (_item) { return _item === item; }),
                        });
