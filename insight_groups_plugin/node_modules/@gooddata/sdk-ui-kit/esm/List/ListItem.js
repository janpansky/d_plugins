...
var SingleSelectListItem = /** @class */ (function (_super) {
    ...
    function SingleSelectListItem(props) {
        ...
        _this.renderSeparatorItem = function () {
            return (React.createElement("div", { role: "item-separator", className: cx("gd-list-item", "gd-list-item-separator", "s-list-separator", _this.props.className) }));
        };
        _this.renderHeaderItem = function () {
            return (React.createElement("div", { role: "item-header", className: cx("gd-list-item", "gd-list-item-header", "s-list-header", _this.props.className) }, _this.props.title));
        };
