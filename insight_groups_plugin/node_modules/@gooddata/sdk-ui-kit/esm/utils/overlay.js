...
function getGlobalPosition(bodyRegion, targetRegion, selfRegion, alignPoint) {
    ...
    var finalOffset = addOffset(globalOffset, cumulativeOffset);
...
function getPositionedSelfRegion(_a) {
    var targetRegion = _a.targetRegion, selfRegion = _a.selfRegion, bodyRegion = _a.bodyRegion, alignPoint = _a.alignPoint;
    var globalPosition = getGlobalPosition(bodyRegion, targetRegion, selfRegion, alignPoint);
...
export function getOptimalAlignmentForRegion(_a) {
    ...
    var bodyRegion = elementRegion(document.body);
