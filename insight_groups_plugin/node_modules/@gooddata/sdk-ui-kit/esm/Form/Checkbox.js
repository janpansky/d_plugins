...
var Checkbox = /** @class */ (function (_super) {
    ...
    Checkbox.prototype.render = function () {
        var _a = this.props, disabled = _a.disabled, name = _a.name, text = _a.text, title = _a.title, value = _a.value, labelSize = _a.labelSize;
        var labelClasses = cx("input-label-text", {
