 ...
 * @internal
 */
export var EllipsisText = function (props) {
    var text = props.text, _a = props.maxLines, maxLines = _a === void 0 ? LINE_NUMBER : _a;
    var _b = __read(useState(true), 2), collapsed = _b[0], setCollapsed = _b[1];
    var intl = useIntl();
    var overflowIndex = useMemo(function () {
        var maxLength = maxLines * LINE_LENGTH;
        var positionWithNewLine = 0;
        for (var i = 0; i < text.length; i++) {
            if (text[i] === "\n" || text[i] === "\r" || text[i] === "\r\n") {
                var usedCharactersOnLine = positionWithNewLine % LINE_LENGTH;
                var remainingCharactersOnLine = LINE_LENGTH - usedCharactersOnLine;
    ...
    return (React.createElement("div", { className: "gd-ellipsis-text" },
        ...
        overflowIndex && (React.createElement("button", { className: "gd-ellipsis-text-button", onClick: function () { return setCollapsed(function (isCollapsed) { return !isCollapsed; }); } }, collapsed
